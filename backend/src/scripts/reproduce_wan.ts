  ...
  const models = [
    {
      ...
      input: {
        prompt:
          'A cinematic shot of a cat sitting on a windowsill, raining outside, 4k, highly detailed',
      },
    },
    {
      id: 'fal-ai/wan-i2v',
      input: {
        ...
        image_url: 'https://storage.googleapis.com/falserverless/model_tests/flux/flux_dev_1.png',
      },
    },
  ];
