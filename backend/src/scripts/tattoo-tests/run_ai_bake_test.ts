...
async function runAiBakeTest() {
  ...
  const prompt =
    "High quality photo of a woman's back with a complex geometric spiritual tattoo down the spine. The tattoo is black ink, perfectly crisp, embedded in skin. Realistic skin texture, soft lighting, 8k, raw photo.";
