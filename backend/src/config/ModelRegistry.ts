...
export const ALL_MODELS: ModelInfo[] = [
    ...
    { id: 'black-forest-labs/flux-dev', name: 'Flux Dev', provider: 'replicate', capability: 'text-to-image', type: 'image', desc: 'Replicate Flux Dev', supportsLora: true },
    { id: 'black-forest-labs/flux-schnell', name: 'Flux Schnell', provider: 'replicate', capability: 'text-to-image', type: 'image', desc: 'Replicate Flux Schnell', tier: 'fast' },
    ...
    { id: 'sdxl-nsfw', name: 'SDXL NSFW', provider: 'replicate', capability: 'text-to-image', type: 'image', desc: 'Unrestricted SDXL' },
    { id: 'juggernaut-xl', name: 'Juggernaut XL', provider: 'replicate', capability: 'text-to-image', type: 'image', desc: 'High detail photorealism' },
    { id: 'deliberate-v6', name: 'Deliberate V6', provider: 'replicate', capability: 'text-to-image', type: 'image', desc: 'Artistic flexibility' },
    ...
    // === TOGETHER AI ===
    { id: 'flux-schnell-free', name: 'Flux Schnell Free', provider: 'together', capability: 'text-to-image', type: 'image', desc: 'Free tier, rate limited', tier: 'fast' },
    { id: 'flux-schnell', name: 'Flux Schnell', provider: 'together', capability: 'text-to-image', type: 'image', desc: 'Fast generation', tier: 'fast' },
    { id: 'flux-dev', name: 'Flux Dev', provider: 'together', capability: 'text-to-image', type: 'image', desc: 'High quality' },
    { id: 'realvis-xl', name: 'RealVis XL', provider: 'together', capability: 'text-to-image', type: 'image', desc: 'Unrestricted photorealism' },
    { id: 'realistic-vision-together', name: 'Realistic Vision', provider: 'together', capability: 'text-to-image', type: 'image', desc: 'Unrestricted' },
    { id: 'dreamshaper-xl', name: 'Dreamshaper XL', provider: 'together', capability: 'text-to-image', type: 'image', desc: 'Creative & artistic' },
    ...
    { id: 'veo-3', name: 'Veo 3', provider: 'google', capability: 'text-to-video', type: 'video', desc: 'Enhanced video' },
    { id: 'veo-3.1', name: 'Veo 3.1', provider: 'google', capability: 'text-to-video', type: 'video', desc: 'Cinematic video', tier: 'quality' },

    // === OPENAI ===
    { id: 'dall-e-3', name: 'DALL-E 3', provider: 'openai', capability: 'text-to-image', type: 'image', desc: 'Creative concepts' },
    { id: 'dall-e-2', name: 'DALL-E 2', provider: 'openai', capability: 'text-to-image', type: 'image', desc: 'Legacy model' },
    ...
    { id: 'sora-2-pro', name: 'Sora 2.0 Pro', provider: 'openai', capability: 'text-to-video', type: 'video', desc: 'High-fidelity cinematic video', tier: 'pro' },

    // === CIVITAI ===
    { id: 'auraflow', name: 'Auraflow', provider: 'civitai', capability: 'text-to-image', type: 'image', desc: 'Artistic flow' },
    { id: 'chroma', name: 'Chroma', provider: 'civitai', capability: 'text-to-image', type: 'image', desc: 'Vibrant colors' },
    { id: 'sdxl-1-0', name: 'SDXL 1.0', provider: 'civitai', capability: 'text-to-image', type: 'image', desc: 'Base SDXL', supportsLora: true },
    { id: 'sdxl-lightning', name: 'SDXL Lightning', provider: 'civitai', capability: 'text-to-image', type: 'image', desc: 'Fast SDXL', tier: 'fast', supportsLora: true },
    { id: 'pony', name: 'Pony', provider: 'civitai', capability: 'text-to-image', type: 'image', desc: 'Anime style' },
    { id: 'pony-v7', name: 'Pony V7', provider: 'civitai', capability: 'text-to-image', type: 'image', desc: 'Latest Pony' },

    // === COMFY (Local) ===
    { id: 'sdxl', name: 'SDXL (Local)', provider: 'comfy', capability: 'text-to-image', type: 'image', desc: 'Local SDXL', supportsLora: true },
    { id: 'flux-dev', name: 'Flux Dev (Local)', provider: 'comfy', capability: 'text-to-image', type: 'image', desc: 'Local Flux', supportsLora: true },
    { id: 'sd15', name: 'SD 1.5 (Local)', provider: 'comfy', capability: 'text-to-image', type: 'image', desc: 'Local SD 1.5', supportsLora: true },
    ...
    { id: 'animatediff', name: 'AnimateDiff (Local)', provider: 'comfy', capability: 'image-to-video', type: 'video', desc: 'Local animation' },
...
export type LoraBaseModel = 'SDXL' | 'Flux' | 'SD1.5' | 'SVD' | 'Wan' | 'Other';
...
const LORA_MODEL_COMPATIBILITY: Record<LoraBaseModel, string[]> = {
    'SDXL': [
        ...
        'black-forest-labs/flux-dev', 'stability-ai/sdxl',
        'sdxl', 'sdxl-1-0', 'sdxl-lightning'
    ],
    'Flux': [
        'fal-ai/flux/dev', 'fal-ai/flux/schnell', 'fal-ai/flux-pro',
    ...
    'SD1.5': ['sd15', 'sd-1-5', 'sd-1-5-lcm', 'sd-1-5-hyper'],
