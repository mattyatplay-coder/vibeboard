...
export const CAMERA_DATABASE: CameraSpec[] = [
    ...
    // =========================================================================
    {
        ...
        prompt_keywords: [
            'high dynamic range', 'natural skin tones', 'cinematic grade',
            'clean shadows', 'organic film texture', 'rich highlight rolloff'
        ],
    ...
    },
    {
        ...
        prompt_keywords: [
            'full frame cinematic', 'shallow depth of field', 'natural colors',
            'premium film look', 'organic grain structure', 'pristine image quality'
        ],
    ...
    },
    {
        ...
        log_color_space: 'ARRI LogC3',
        prompt_keywords: [
            'documentary style', 'run and gun', 'natural rendering',
            'broadcast quality', 'true-to-life colors'
        ],
    ...
    // =========================================================================
    {
        ...
        prompt_keywords: [
            'ultra high resolution', 'extreme detail', 'modern digital cinema',
            'sharp rendering', 'high contrast', 'bold colors'
        ],
    ...
    },
    {
        ...
        log_color_space: 'REDWideGamutRGB',
        prompt_keywords: [
            'compact cinema', 'high frame rate', 'sharp digital',
            'modern blockbuster look', 'punchy colors'
        ],
    ...
    },
    {
        ...
        log_color_space: 'REDWideGamutRGB',
        prompt_keywords: [
            'low light champion', 'clean high ISO', 'night shooting',
            'dual ISO performance', 'cinematic low light'
        ],
    ...
    // =========================================================================
    {
        ...
        prompt_keywords: [
            'full frame cinema', 'dual base ISO', 'highlight rolloff',
            'premium production', 'Netflix approved', 'rich color science'
        ],
    ...
    },
    {
        ...
        prompt_keywords: [
            'run and gun cinema', 'documentary filmmaker', 'versatile',
            'compact full frame', 'professional broadcast'
        ],
    ...
    },
    {
        ...
        log_color_space: 'S-Log3',
        prompt_keywords: [
            'low light king', 'mirrorless cinema', 'clean high ISO',
            'compact full frame', 'content creator'
        ],
    ...
    },
    {
        ...
        log_color_space: 'S-Log3',
        prompt_keywords: [
            'cinematic mirrorless', 'compact cinema', 'gimbal friendly',
            'indie filmmaker', 'content creation'
        ],
        aspect_ratios: ['16:9', '17:9'],
    },
    ...
    // =========================================================================
    {
        ...
        prompt_keywords: [
            'cinema EOS', 'modular design', 'dual pixel AF',
            'Netflix approved', 'natural skin tones'
        ],
    ...
    },
    {
        ...
        log_color_space: 'Canon Log 3',
        prompt_keywords: [
            'RF mount cinema', 'compact pro', 'dual pixel AF',
            'documentary style', 'run and gun'
        ],
        aspect_ratios: ['16:9', '4:3'],
    },
    {
        ...
        log_color_space: 'Canon Log 3',
        prompt_keywords: [
            'hybrid shooter', '8K mirrorless', 'high resolution',
            'stills and video', 'professional photography'
        ],
    ...
    // =========================================================================
    {
        ...
        prompt_keywords: [
            'indie cinema', 'RAW workflow', 'DaVinci Resolve',
            'affordable cinema', 'EF mount', 'organic film look'
        ],
    ...
    },
    {
        ...
        log_color_space: 'Blackmagic Film Gen 5',
        prompt_keywords: [
            'compact cinema', 'budget filmmaking', 'ProRes ready',
            'indie production', 'film student'
        ],
        aspect_ratios: ['16:9', '2.4:1'],
    },
    {
        ...
        log_color_space: 'Blackmagic Film Gen 5',
        prompt_keywords: [
            'ultra high resolution', 'VFX plate', 'extreme crop',
            'future proof', '12K RAW'
        ],
        aspect_ratios: ['17:9', '16:9', '2.4:1'],
    },
    ...
    // =========================================================================
    {
        ...
        prompt_keywords: [
            'micro four thirds', 'deep depth of field', 'compact system',
            'vlogger friendly', 'stabilized video'
        ],
        aspect_ratios: ['16:9', '4:3', '3:2'],
    },
    {
        ...
        log_color_space: 'V-Log',
        prompt_keywords: [
            'full frame mirrorless', 'Netflix approved', 'dual native ISO',
            'compact cinema', 'hybrid shooter'
        ],
    ...
    // =========================================================================
    {
        ...
        prompt_keywords: [
            'smartphone cinema', 'vertical video', 'social media',
            'deep depth of field', 'HDR video', 'computational photography'
        ],
    ...
    },
    {
        ...
        log_color_space: 'Apple Log',
        prompt_keywords: [
            'ProRes mobile', 'cinematic mode', 'action mode',
            'TikTok style', 'Instagram reels', 'mobile filmmaking'
        ],
        aspect_ratios: ['16:9', '9:16', '4:3'],
    },
    {
        ...
        prompt_keywords: [
            'android flagship', '8K mobile', 'high zoom',
            'social media content', 'mobile journalism'
        ],
        aspect_ratios: ['16:9', '9:16', '4:3'],
    },
    ...
    // =========================================================================
    {
        ...
        prompt_keywords: [
            'medium format', 'ultra shallow depth of field', 'fashion photography',
            'extreme detail', 'billboard quality', 'editorial'
        ],
    ...
    },
    {
        ...
        prompt_keywords: [
            'medium format cinema', 'commercial photography', 'fashion',
            'extreme resolution', 'studio quality', 'beauty work'
        ],
    ...
    // =========================================================================
    {
        ...
        model: 'HERO 13 Black',
        category: 'action',
        sensor_spec: { width_mm: 6.17, height_mm: 4.55, diagonal_mm: 7.66, crop_factor_ff: 5.65, coc_mm: 0.005 },
        resolution: '5.3K',
        base_iso: 100,
        log_color_space: 'GP-Log',
        prompt_keywords: [
            'action camera', 'wide angle POV', 'extreme sports',
            'fisheye distortion', 'adventure footage', 'rugged'
        ],
    ...
    },
    {
        ...
        prompt_keywords: [
            'action POV', 'stabilized action', 'vlogging',
            'dual screen', 'extreme sports', 'underwater'
        ],
        aspect_ratios: ['16:9', '4:3', '9:16'],
    },
];
...
export const LENS_FAMILIES: LensFamily[] = [
    ...
    // =========================================================================
    {
        ...
        is_anamorphic: false,
        prompt_keywords: [
            'clinical sharpness', 'zero aberration', 'high contrast',
            'perfect optical quality', 'no distortion', 'modern precision'
        ],
    },
    {
        ...
        is_anamorphic: false,
        prompt_keywords: [
            'large format', 'modern cine', 'subtle character',
            'beautiful bokeh', 'smooth falloff', 'pleasing skin tones'
        ],
    },
    {
        ...
        is_anamorphic: false,
        prompt_keywords: [
            'compact cine', 'modern look', 'sharp rendering',
            'budget friendly', 'clean optics'
        ],
    },
    ...
    // =========================================================================
    {
        ...
        is_anamorphic: false,
        prompt_keywords: [
            'Cooke Look', 'warm skin tones', 'creamy bokeh',
            'organic rendering', 'subtle edge glow', 'classic cinema'
        ],
    },
    {
        id: 'cooke_s7i',
        ...
        is_anamorphic: false,
        prompt_keywords: [
            'full frame Cooke', 'large format warmth', 'creamy highlights',
            'natural skin', 'organic character', 'cinematic warmth'
        ],
    },
    {
        ...
        squeeze_factor: 2.0,
        prompt_keywords: [
            'oval bokeh', '2x anamorphic', 'subtle flare',
            'widescreen cinema', 'classic Hollywood', 'epic scope'
        ],
        flare_color: 'amber',
    },
    ...
    // =========================================================================
    {
        ...
        is_anamorphic: false,
        prompt_keywords: [
            'large format', 'Hollywood premium', 'pristine optics',
            'smooth falloff', 'natural rendering', 'A-list production'
        ],
    },
    {
        ...
        squeeze_factor: 2.0,
        prompt_keywords: [
            'vintage anamorphic', 'blue streak flare', 'oval bokeh',
            'classic Hollywood', 'Lawrence of Arabia', 'epic widescreen'
        ],
        flare_color: 'blue',
    },
    {
        ...
        is_anamorphic: false,
        prompt_keywords: [
            'fast aperture', 'low light', 'extreme bokeh',
            'razor thin focus', 'vintage warmth'
        ],
    },
    ...
    // =========================================================================
    {
        ...
        is_anamorphic: false,
        prompt_keywords: [
            'ARRI look', 'warm and forgiving', 'beautiful skin',
            'gentle highlight rolloff', 'full frame native', 'premium cinema'
        ],
    },
    {
        ...
        squeeze_factor: 2.0,
        prompt_keywords: [
            'modern anamorphic', 'controlled flare', 'oval bokeh',
            'clean widescreen', 'contemporary cinema', 'refined character'
        ],
        flare_color: 'cyan',
    },
    ...
    // =========================================================================
    {
        ...
        is_anamorphic: false,
        prompt_keywords: [
            'affordable cinema', 'sharp modern', 'full frame coverage',
            'indie filmmaker', 'high value', 'clean rendering'
        ],
    },
    {
        id: 'sigma_art',
        ...
        is_anamorphic: false,
        prompt_keywords: [
            'photo lens cine', 'ultra sharp', 'clinical',
            'high resolution', 'budget cinema', 'content creator'
        ],
    },
    ...
    // =========================================================================
    {
        ...
        is_anamorphic: false,
        prompt_keywords: [
            'vintage Cooke', '1930s Hollywood', 'soft glow',
            'romantic rendering', 'low contrast', 'period film'
        ],
    },
    {
        ...
        is_anamorphic: false,
        prompt_keywords: [
            'golden age Hollywood', 'soft focus', 'warm rendering',
            'classic cinema', 'film noir', 'romantic glow'
        ],
    },
    {
        id: 'helios_44',
        ...
        is_anamorphic: false,
        prompt_keywords: [
            'swirly bokeh', 'Soviet lens', 'dreamy background',
            'artistic rendering', 'portrait character', 'unique look'
        ],
    },
    {
        id: 'canon_fd',
        ...
        is_anamorphic: false,
        prompt_keywords: [
            '1970s look', 'warm flare', 'organic rendering',
            'low contrast', 'vintage warmth', 'nostalgic'
        ],
    },
    ...
    // =========================================================================
    {
        ...
        is_anamorphic: false,
        prompt_keywords: [
            'macro probe', 'bug perspective', 'miniature world',
            'extreme close-up', 'product shot', 'tiny perspective'
        ],
    },
    {
        id: 'lensbaby_velvet',
        ...
        is_anamorphic: false,
        prompt_keywords: [
            'ethereal glow', 'soft focus portrait', 'dreamy',
            'romantic haze', 'fantasy look', 'skin smoothing'
        ],
    },
    {
        id: 'petzval_85',
        ...
        is_anamorphic: false,
        prompt_keywords: [
            'swirly bokeh', 'vintage brass', 'artistic portrait',
            'vignette', 'center sharpness', '1840s optics'
        ],
    },
    ...
    // =========================================================================
    {
        ...
        squeeze_factor: 2.0,
        prompt_keywords: [
            'modern anamorphic', 'amber flare', 'oval bokeh',
            'indie anamorphic', 'affordable widescreen', 'cinematic scope'
        ],
        flare_color: 'amber',
    },
    {
        ...
        squeeze_factor: 1.33,
        prompt_keywords: [
            '1.33x anamorphic', 'blue flare', 'budget anamorphic',
            'content creator', 'entry level widescreen'
        ],
        flare_color: 'blue',
    },
];
...
export function buildCinematicModifier(cameraId: string, lensId: string): string {
    ...
    if (lens) {
        ...
        keywords.push(`${lens.brand} ${lens.model} ${lens.focal_length_mm}mm T${lens.min_t_stop.toFixed(1)} lens`);
 ...
 */
export function buildCameraPrompt(cameraId: string, lensId: string, additionalKeywords?: string[]): string {
