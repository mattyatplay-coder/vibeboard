 ...
 *
 * P0 SECURITY: All GPU operations require authentication.
 * GPU compute is VERY EXPENSIVE ($0.10-$1.00+ per request).
 */
 ...
 * (No auth required - just a health check)
 */
 ...
 * VERY EXPENSIVE: GPU compute for video generation
 */
router.post(
  '/video/generate',
  withAuth,
