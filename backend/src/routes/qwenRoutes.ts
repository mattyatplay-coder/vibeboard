...
/**
 * POST /api/qwen/edit
 * Core Qwen image editing endpoint
 */
 ...
 */
router.post('/reshoot', async (req: Request, res: Response) => {
    try {
...
router.post('/assemble', async (req: Request, res: Response) => {
    try {
        ...
        const result = await falAdapter.assembleCharacters(
            characterImages,
            sceneDescription,
            { backgroundImage, seed, imageSize }
        );
 ...
 */
router.post('/fabricate-prop', async (req: Request, res: Response) => {
    try {
 ...
 */
router.post('/fix-text', async (req: Request, res: Response) => {
    try {
 ...
 */
router.post('/generate-pose', async (req: Request, res: Response) => {
    try {
        const {
            sourceImage,
            poseInstruction,
