...
export const MODEL_PROMPTING_GUIDES: Record<string, ModelPromptGuide> = {
  ...
  'flux-dev': {
    ...
    stylePrefixes: ['in the style of', 'rendered as', 'artistic interpretation of'],
    avoidTerms: [
      'ugly',
      'deformed',
      'noisy',
      'blurry',
      'low quality', // These don't work without negatives
    ],
    recommendedSettings: {
      cfgScale: [3.5, 4.5],
      steps: [28, 50],
    ...
    examples: [
      {
        ...
        output:
          'ohwx woman, elegant young woman with flowing auburn hair and green eyes, sitting at a rustic wooden table in a cozy artisan coffee shop, warm morning light streaming through large windows, holding a ceramic latte cup, wearing a cream cashmere sweater, soft bokeh background with exposed brick walls, professional portrait photography, highly detailed, sharp focus, 8k resolution',
    ...
    examples: [
      {
        input: 'a man running',
        output:
          'ohwx man, athletic man with short dark hair, running through city streets at sunset, dynamic pose mid-stride, urban environment, cinematic lighting, high quality',
  ...
  'flux-pro': {
    ...
    stylePrefixes: ['in the style of', 'rendered as', 'artistic interpretation of'],
    avoidTerms: ['ugly', 'deformed', 'noisy', 'blurry', 'low quality'],
    recommendedSettings: {
      cfgScale: [3.5, 4.5],
      steps: [28, 50],
    },
    ...
    examples: [
      {
        ...
        output:
          'ohwx_scene, neon-lit cyberpunk street at night, rain slicked pavement reflecting colorful lights, towering skyscrapers with holographic advertisements, diverse crowd of futuristic citizens, flying cars overhead, cinematic lighting, highly detailed, 8k resolution',
    ...
    examples: [
      {
        ...
        output:
          'ohwx_warrior, fierce warrior in intricate armor, standing on a battlefield, smoke and embers in the air, determined expression, detailed textures on armor, dramatic lighting, cinematic composition, next gen quality, 8k resolution',
    ...
    examples: [
      {
        ...
        output:
          'ohwx_scene, breathtaking mountain landscape at golden hour, dramatic peaks with snow caps, crystal clear alpine lake reflection, wispy clouds, professional landscape photography, ultra high resolution, 4K',
  ...
  'flux-kontext': {
    ...
    stylePrefixes: ['in the style of the reference', 'maintaining appearance from reference'],
    avoidTerms: ['different person', 'changed appearance', 'blurry', 'low quality'],
    recommendedSettings: {
      cfgScale: [3.5, 4.5],
      steps: [28, 50],
    },
    ...
    examples: [
      {
        ...
        output:
          'same character from reference image, now standing in heroic pose with arms crossed, dramatic studio lighting, professional portrait, consistent facial features, high quality',
  ...
  'flux-fill': {
    ...
    qualityBoosters: ['seamless', 'natural blend', 'consistent lighting', 'matching texture'],
    stylePrefixes: ['fill with', 'replace with', 'add'],
    avoidTerms: ['visible seam', 'mismatched', 'inconsistent'],
    recommendedSettings: {},
    ...
    examples: [
      {
        ...
        output:
          'natural background continuation, matching lighting and texture, seamless blend with surrounding area, consistent perspective',
  ...
  'flux-depth': {
    ...
    stylePrefixes: ['restyle as', 'transform to', 'convert to'],
    avoidTerms: ['distorted structure', 'wrong perspective', 'depth errors'],
    recommendedSettings: {},
    ...
    examples: [
      {
        ...
        output:
          'cyberpunk interior with neon lighting and holographic displays, maintaining original room layout and furniture positions, depth consistent, high quality',
  ...
  'flux-canny': {
    ...
    qualityBoosters: ['edge accurate', 'outline preserved', 'shape consistent', 'high quality'],
    stylePrefixes: ['render as', 'style as', 'create'],
    avoidTerms: ['wrong edges', 'distorted outline', 'shape errors'],
    recommendedSettings: {},
    ...
    examples: [
      {
        ...
        output:
          'realistic portrait following sketch outlines, detailed skin texture, natural lighting, edge accurate, high quality photorealistic',
  ...
  'flux-redux': {
    ...
    qualityBoosters: ['high quality variation', 'creative interpretation', 'detailed'],
    stylePrefixes: ['variation of', 'reimagined as', 'alternative version'],
    avoidTerms: ['exact copy', 'identical'],
    recommendedSettings: {},
    ...
    examples: [
      {
        ...
        output:
          'variation of original portrait, dramatic side lighting with deep shadows, maintaining subject identity, high quality creative interpretation',
  ...
  'ip-adapter-face-id': {
    ...
    qualityBoosters: ['face accurate', 'identity preserved', 'high quality', 'detailed features'],
    stylePrefixes: ['portrait of', 'photo of', 'image of'],
    avoidTerms: ['different face', 'changed identity', 'wrong person'],
    recommendedSettings: {},
    ...
    examples: [
      {
        ...
        output:
          'professional woman with preserved face identity from reference, standing in modern office, business attire, confident pose, natural lighting, high quality portrait',
    ...
    examples: [
      {
        ...
        output:
          'inspirational poster with text "BELIEVE IN YOURSELF" in bold modern typography, sunrise over mountains, warm golden colors, professional graphic design, high quality',
    ...
    examples: [
      {
        ...
        output:
          'character sheet of armored fantasy warrior, front view, side view, back view, three-quarter view, consistent design across all poses, detailed armor, professional concept art, reference sheet',
        notes:
          'Ideogram Character specializes in character sheets, turnarounds, and reference poses',
      },
    ],
  },
  ...
  hidream: {
    ...
    stylePrefixes: ['high resolution image of', 'detailed render of'],
    avoidTerms: ['low resolution', 'blurry', 'low quality'],
    recommendedSettings: {},
    ...
    examples: [
      {
        ...
        output:
          'ohwx_scene, epic fantasy landscape with floating islands, waterfalls cascading into clouds, ancient ruins, dramatic lighting, exceptional detail, high resolution, professional concept art',
  ...
  janus: {
    ...
    qualityBoosters: ['creative', 'artistic', 'detailed', 'high quality'],
    stylePrefixes: ['creative interpretation of', 'artistic render of'],
    avoidTerms: ['low quality', 'blurry'],
    recommendedSettings: {},
    ...
    examples: [
      {
        ...
        output:
          'ohwx_scene, surreal dreamscape with melting clocks and floating geometric shapes, ethereal lighting, impossible architecture, creative artistic interpretation, high quality',
    ...
    examples: [
      {
        ...
        output:
          'astronaut ohwx_astronaut in detailed spacesuit, standing on alien planet with purple sky and twin moons, bioluminescent vegetation, dramatic alien landscape, highly detailed, photorealistic, professional quality',
  ...
  'gpt-image': {
    ...
    qualityBoosters: ['highly detailed', 'professional', 'sharp', 'high quality'],
    stylePrefixes: ['image of', 'photograph of', 'render of'],
    avoidTerms: ['low quality', 'blurry', 'distorted'],
    recommendedSettings: {},
    ...
    examples: [
      {
        ...
        output:
          'ohwx_scene, modern minimalist kitchen interior with marble countertops, stainless steel appliances, natural wood accents, morning sunlight through large windows, interior design photography, highly detailed, professional quality',
  ...
  'creative-upscaler': {
    ...
    qualityBoosters: ['enhanced detail', 'improved texture', 'sharpened', 'high resolution'],
    stylePrefixes: ['upscale with', 'enhance'],
    avoidTerms: ['blur', 'artifacts', 'noise'],
    recommendedSettings: {},
    ...
    examples: [
      {
        ...
        output:
          'enhance and upscale portrait, add skin texture detail, sharpen facial features, improve hair detail, 4x resolution, high quality',
  ...
  'clarity-upscaler': {
    ...
    qualityBoosters: ['sharp', 'faithful', 'preserved original', 'clean upscale'],
    stylePrefixes: ['upscale faithfully', 'sharpen'],
    avoidTerms: ['altered', 'changed', 'modified'],
    recommendedSettings: {},
    ...
    examples: [
      {
        ...
        output:
          'faithfully upscale photograph, preserve original details and colors, sharp edges, clean upscale, maintain integrity',
        notes:
          'Clarity Upscaler provides sharp, faithful upscaling preserving original image integrity',
      },
    ],
  },
    ...
    examples: [
      {
        ...
        output:
          'icon of red apple, vector art style, clean lines, flat design, minimal shading, white background, high quality svg',
    ...
    examples: [
      {
        ...
        output:
          'neon sign text "Hello" glowing in blue and pink, brick wall background, cyber aesthetic, high quality typography, graphic design',
    ...
    examples: [
      {
        input: 'cyberpunk street',
        output:
          'ohwx_scene, bustling cyberpunk street at night, neon signs reflecting on wet pavement, futuristic vehicles, cinematic lighting, highly detailed, 8k resolution',
  ...
  sdxl: {
    ...
    stylePrefixes: ['in style of', 'art by', 'aesthetic of'],
    ...
    examples: [
      {
        ...
        output:
          'ohwx_elf, masterpiece, best quality, highly detailed, 1girl, beautiful elven woman, (pointed ears:1.2), long silver hair, ethereal blue eyes, wearing ornate golden circlet, forest background with magical particles, soft ethereal lighting, fantasy art style, portrait shot, sharp focus',
    ...
    examples: [
      {
        ...
        output:
          'ohwx_char, masterpiece, best quality, highly detailed, 1girl, young woman, long black hair, determined expression, holding katana, dynamic battle pose, cherry blossom forest, dramatic lighting, anime style, sharp focus',
  ...
  'realistic-vision': {
    ...
    avoidTerms: ['cartoon', 'anime', 'illustration', 'painting', 'drawing'],
    recommendedSettings: {
      cfgScale: [4, 7],
      steps: [25, 40],
    ...
    examples: [
      {
        ...
        output:
          'ohwx_woman, RAW photo, professional businesswoman, (same face:1.3), sharp features, wearing tailored navy suit, confident stance, modern office with city skyline, natural window light, shot on Canon EOS R5, 85mm lens, shallow depth of field, 8k uhd, photorealistic',
    ...
    examples: [
      {
        ...
        output:
          'score_9, score_8_up, ohwx_magical, 1girl, magical girl, (consistent character:1.2), twintails, pink hair, sparkling eyes, frilly dress, holding magic wand, dynamic pose, starry night background, beautiful lighting, source_anime',
    ...
    examples: [
      {
        ...
        output:
          'ohwx_woman, elegant woman with long brown hair wearing summer dress, walking gracefully through sunlit park, gentle breeze moving her hair, smooth tracking shot following her movement, lush green trees and blooming flowers, golden hour lighting, cinematic quality, 4k',
  ...
  'ltx-video': {
    ...
    qualityBoosters: ['high quality video', 'smooth motion', 'cinematic', 'detailed'],
    ...
    examples: [
      {
        ...
        output:
          'ohwx_man, professional man with glasses, sitting at modern desk, typing on laptop with focused expression, hands moving across keyboard, contemporary office setting, soft ambient lighting, slight camera push in, high quality video',
  ...
  'hailuo-director': {
    ...
    qualityBoosters: ['cinematic quality', 'professional lighting', 'detailed'],
    stylePrefixes: [],
    avoidTerms: [],
    recommendedSettings: {
      steps: [50, 50],
    ...
    examples: [
      {
        ...
        output:
          '[Push in, Truck left] Elegant woman ohwx_char with contemplative expression, standing by large window, gazing at rainy cityscape, soft reflections on glass, moody interior lighting, cinematic quality',
    ...
    examples: [
      {
        ...
        output:
          'ohwx_dog, golden retriever running joyfully through tall grass field, ears flapping in wind, dynamic camera tracking side view, sunny afternoon lighting, cinematic quality, 4k',
    ...
    examples: [
      {
        ...
        output:
          'ohwx_city, neon-lit cyberpunk street at night, rain falling on pavement, flying cars passing overhead, dynamic camera tracking forward, cinematic lighting, high fidelity, 4k',
    ...
    examples: [
      {
        ...
        output:
          'ohwx_astronaut, astronaut in detailed white spacesuit floating in zero gravity, earth visible in background reflection of visor, slow smooth rotation, cinematic lighting from distant sun, 8k, masterpiece',
    ...
    examples: [
      {
        ...
        output:
          'ohwx_char, cyberpunk street portrait, neon lights reflecting on wet pavement, futuristic clothing, detailed facial features, cinematic lighting, 8k resolution, masterpiece',
    ...
    examples: [
      {
        ...
        output:
          'ohwx_woman, professional woman in business suit speaking confidently, office background with soft focus, studio lighting, high fidelity, lip sync accuracy, 4k',
  ...
  'kling-avatar-v2-standard': {
    ...
    qualityBoosters: ['high quality', 'clear audio', 'smooth motion'],
    ...
    examples: [
      {
        input: 'man talking',
        output:
          'ohwx_man, man in casual shirt talking naturally, living room background, daylight, high quality',
    ...
    examples: [
      {
        input: 'lion roaring',
        output:
          'ohwx_lion, majestic male lion with full mane roaring on savanna, mouth wide open showing teeth, wind blowing through mane, golden hour lighting, cinematic 4k video, photorealistic',
    ...
    examples: [
      {
        ...
        output:
          'ohwx_woman, elegant woman in red dress walking through neon-lit city streets at night, smooth tracking shot, rain-slicked pavement reflecting lights, cinematic 4k video, 1080p, photorealistic',
    ...
    examples: [
      {
        ...
        output:
          '@Video1 running through dense forest, @Video2 follows behind, dynamic camera tracking, sunlight filtering through trees, cinematic quality, 1080p',
        notes:
          'Use @Video1, @Video2, @Video3 to reference up to 3 uploaded videos for character consistency',
      },
      {
        input: 'two characters talking',
        output:
          '@Video1 and @Video2 having conversation in coffee shop, natural gestures, warm ambient lighting, medium shot, cinematic quality',
    ...
    examples: [
      {
        ...
        output:
          'ohwx_scene, massive ocean waves crashing against rocky cliffs at sunset, spray catching golden light, dramatic slow-motion, aerial tracking shot, professional video quality, 4k',
    ...
    examples: [
      {
        ...
        output:
          'ohwx_scene, dramatic thunderstorm over night city skyline, lightning illuminating skyscrapers, rain falling, thunder rumbling, cinematic quality, with sound effects',
  ...
  'vidu-q2': {
    ...
    qualityBoosters: ['cinematic', 'high quality', 'character consistent', 'smooth motion'],
    ...
    examples: [
      {
        ...
        output:
          'character 1 and character 2 from references meeting in coffee shop, shaking hands, friendly smiles, warm interior lighting, character consistent, cinematic quality',
  ...
  'vidu-i2v': {
    ...
    qualityBoosters: ['smooth animation', 'high quality', 'natural motion', 'with sound'],
    ...
    examples: [
      {
        ...
        output:
          'animate portrait from image, gentle head turn with natural eye movement, soft ambient sound, smooth high quality animation',
  ...
  pixverse: {
    ...
    qualityBoosters: ['cinematic', 'high quality motion', 'smooth animation', '4k'],
    stylePrefixes: ['video of', 'cinematic shot of'],
    ...
    examples: [
      {
        ...
        output:
          'ohwx_bird, colorful parrot flying through dense tropical forest, smooth wing motion, camera tracking alongside, dappled sunlight, cinematic quality, 4k',
  ...
  magi: {
    ...
    qualityBoosters: ['artistic', 'creative style', 'stylized', 'unique aesthetic'],
    ...
    examples: [
      {
        ...
        output:
          'ohwx_dancer, abstract interpretation of dance performance, flowing geometric shapes following movement, surreal color palette, artistic style, creative animation',
  ...
  'luma-ray-2': {
    ...
    qualityBoosters: ['realistic', 'natural motion', 'cinematic', 'smooth camera', 'high quality'],
    ...
    examples: [
      {
        ...
        output:
          'ohwx_car, sleek sports car driving through winding mountain road, smooth camera tracking, realistic motion blur, dramatic cliff views, cinematic quality, natural lighting',
  ...
  'luma-ray-2-i2v': {
    ...
    qualityBoosters: ['realistic motion', 'smooth animation', 'natural camera', 'high quality'],
    stylePrefixes: ['animate', 'bring to life'],
    ...
    examples: [
      {
        ...
        output:
          'animate scenic mountain landscape from image, gentle cloud movement, flowing water in stream, subtle camera push forward, realistic motion, high quality',
    ...
    examples: [
      {
        ...
        output:
          'Animate portrait from image. Subject turns head with subtle smile. Slow push in on face. Cinematic lighting, high quality, fast generation.',
  ...
  'hunyuan-i2v': {
    ...
    qualityBoosters: ['diverse motion', 'open source quality', 'smooth animation'],
    ...
    examples: [
      {
        ...
        output:
          'animate forest scene from image, leaves rustling in wind, butterflies fluttering, diverse natural motion, smooth animation quality',
    ...
    examples: [
      {
        ...
        output:
          'professional business woman from portrait, natural speaking expressions, confident delivery, high fidelity face preservation, lip sync accurate, natural lighting',
  ...
  'one-to-all-animation': {
    ...
    qualityBoosters: ['accurate pose transfer', 'smooth motion', 'character preserved'],
    ...
    examples: [
      {
        ...
        output:
          'anime character from image, transfer dance motion from driving video, maintain character appearance, accurate pose transfer, smooth motion',
        notes:
          'One-To-All Animation transfers pose and motion from a driving video to your character',
      },
    ],
  },
  ...
  'wan-animate-move': {
    ...
    qualityBoosters: ['motion transfer', 'character consistent', 'smooth animation'],
    ...
    examples: [
      {
        ...
        output:
          'character from source image, walking motion transferred from driving video, maintain character identity, smooth walk cycle animation, high quality',
  ...
  'wan-vace-inpainting': {
    ...
    qualityBoosters: ['seamless blend', 'temporal consistency', 'natural fill'],
    ...
    examples: [
      {
        ...
        output:
          'in masked region: continue background naturally, matching lighting and perspective, seamless blend across frames, temporal consistency, high quality',
  ...
  'kling-o1-video-edit': {
    ...
    qualityBoosters: ['high quality edit', 'consistent transformation', 'smooth transition'],
    ...
    examples: [
      {
        ...
        output:
          'transform video to anime art style, maintain motion and composition, consistent style across all frames, smooth transformation, high quality',
  ...
  'minimax-video': {
    ...
    qualityBoosters: ['high quality', 'smooth', 'cinematic'],
    stylePrefixes: [],
    avoidTerms: [],
    recommendedSettings: {},
    template: `{trigger_words} {subject_description}, {action_movement}, {setting_background}, {style}`,
    examples: [
      {
        input: 'cat sleeping',
        output:
          'ohwx_cat, fluffy white cat sleeping on velvet cushion, chest rising and falling rhythmically, soft morning light, peaceful atmosphere, high quality video',
    ...
    examples: [
      {
        ...
        output:
          'ocean waves crashing on rocky shore, spray flying in air, dynamic camera movement, sunset lighting, cinematic quality, 4k video',
    ...
    examples: [
      {
        ...
        output:
          'camera flying through fluffy white clouds, blue sky, sun rays piercing through, dreamlike atmosphere, smooth motion, high quality',
    ...
    examples: [
      {
        input: 'car chase',
        output:
          'High speed car chase on highway. Red sports car weaving through traffic. Dynamic camera tracking. Sunset lighting with lens flares. Cinematic movie scene, high fidelity.',
    ...
    examples: [
      {
        input: 'forest stream',
        output:
          'clear stream flowing through ancient forest, sunlight filtering through leaves, smooth camera tracking downstream, nature documentary style, 4k video',
    ...
    examples: [
      {
        ...
        output:
          'ohwx_girl, masterpiece, best quality, 1girl, dancing, spinning, frilly dress, stage lights, anime style, smooth animation',
  ...
  'dall-e-3': {
    ...
    stylePrefixes: ['in the style of', 'reminiscent of', 'artistic interpretation of'],
    avoidTerms: [
    ...
    examples: [
      {
        ...
        output:
          'Graceful ballet dancer ohwx_dancer, performing elegant pirouette in grand theater, flowing white tutu catching stage lights, smooth continuous rotation, ornate golden interior with velvet seats, dramatic spotlight with soft ambient fill, cinematic quality, professional production',
    ...
    examples: [
      {
        ...
        output:
          'Brilliant scientist ohwx_scientist with safety goggles, examining glowing chemical reaction in beaker, modern laboratory with advanced equipment, dramatic blue and green lighting from experiments, documentary photography style, highly detailed, professional quality',
...
export function getModelGuide(modelId: string): ModelPromptGuide | null {
  ...
  if (
    ...
    (lowerId.includes('v2.6') || lowerId.includes('2.6') || lowerId.includes('wan-2.6'))
  ) {
  ...
  if (
    lowerId.includes('wan') &&
    (lowerId.includes('22') ||
      lowerId.includes('2.2') ||
      lowerId.includes('21') ||
      lowerId.includes('2.1') ||
...
export const NEGATIVE_PROMPT_TEMPLATES: Record<string, string> = {
  ...
  'sd3-5-large':
    'lowres, bad anatomy, bad hands, text, error, missing fingers, extra digit, fewer digits, cropped, worst quality, low quality, jpeg artifacts, signature, watermark, blurry, deformed, disfigured, mutated',
  'realistic-vision':
    '(deformed iris, deformed pupils, semi-realistic, cgi, 3d, render, sketch, cartoon, drawing, anime:1.4), text, close up, cropped, out of frame, worst quality, low quality, jpeg artifacts, ugly, duplicate, morbid, mutilated, extra fingers, mutated hands, poorly drawn hands, poorly drawn face, mutation, deformed, blurry, dehydrated, bad anatomy, bad proportions, extra limbs, cloned face, disfigured, gross proportions, malformed limbs, missing arms, missing legs, extra arms, extra legs, fused fingers, too many fingers, long neck',
  'pony-diffusion':
    'score_4, score_3, score_2, score_1, lowres, bad anatomy, bad hands, text, error, missing fingers, extra digit, fewer digits, cropped, worst quality, low quality, normal quality, jpeg artifacts, signature, watermark, username, blurry',
  ...
  'flux-2':
    'blurry, low quality, distorted, deformed, ugly, bad anatomy, watermark, signature, text, artifacts, oversaturated',

  // === VIDEO MODELS ===
  'wan-v2-2':
    'static, frozen, blurry, low quality, distorted faces, morphing, flickering, jittery motion, bad anatomy, deformed',
  'wan-v2-5':
    'static, frozen, blurry, low quality, distorted faces, morphing, flickering, jittery motion, bad anatomy, deformed, inconsistent character',
  'wan-v2-6':
    'static, frozen, blurry, low quality, distorted faces, morphing, flickering, jittery motion, bad anatomy, deformed, inconsistent character, audio desync',
  'wan-v2-6-r2v':
    'static, frozen, blurry, low quality, distorted faces, morphing, flickering, jittery motion, bad anatomy, deformed, inconsistent character, reference mismatch, audio desync',
  'kling-video-v2-1':
    'static, blurry, low quality, distorted, flickering, jittery, morphing faces, bad anatomy, deformed',
  'kling-video-v2-6':
    'static, blurry, low quality, distorted, flickering, jittery, morphing faces, bad anatomy, deformed, audio sync issues',
  'kling-video-o1':
    'static, blurry, low quality, distorted, flickering, jittery, morphing faces, bad anatomy, deformed, inconsistent character',
  'ltx-video':
    'static, frozen, blurry, low quality, distorted, flickering, jittery motion, morphing, bad anatomy',
  'hailuo-director':
    'static, blurry, low quality, distorted, flickering, jittery, morphing, bad anatomy, wrong camera movement',
  'runway-gen3':
    'static, blurry, low quality, distorted, flickering, morphing, bad anatomy, deformed, jittery',
  'runway-gen4':
    'static, blurry, low quality, distorted, flickering, morphing, bad anatomy, deformed, jittery, inconsistent',
  'luma-dream-machine':
    'static, frozen, blurry, low quality, distorted, flickering, glitchy, morphing, bad physics',
  'hunyuan-video':
    'static, frozen, blurry, low quality, distorted, flickering, jittery, morphing faces, bad anatomy',
  'minimax-video': 'static, frozen, blurry, low quality, distorted, flickering, jittery, morphing',
  animatediff:
    'lowres, bad anatomy, bad hands, text, worst quality, low quality, blurry, static, frozen, jittery, morphing',
  'veo-2':
    'static, frozen, blurry, low quality, distorted, flickering, morphing, bad anatomy, deformed',
  'veo-3':
    'static, frozen, blurry, low quality, distorted, flickering, morphing, bad anatomy, deformed, inconsistent',
  sora: 'static, blurry, low quality, distorted, flickering, morphing, bad physics, unrealistic motion, deformed',

  // === IMAGE MODELS ===
  'recraft-v3':
    'blurry, pixelated, low resolution, bad lines, inconsistent style, raster artifacts',
  'ideogram-v2':
    'blurry, low quality, typos, misspellings, wrong text, bad typography, distorted letters',
  'dall-e-3': 'blurry, low quality, distorted, deformed, bad anatomy, watermark, text errors',
  'imagen-3':
    'blurry, low quality, distorted, deformed, bad anatomy, watermark, artifacts, oversaturated',
  'fal-ai/kling-image/o1':
    'blurry, low quality, distorted, deformed, bad anatomy, watermark, artifacts',

  // === AVATAR MODELS ===
  'kling-avatar-v2-pro':
    'blurry, distorted face, out of sync, unnatural mouth movements, frozen, static, glitchy audio',
  'kling-avatar-v2-standard':
    'blurry, distorted face, out of sync, unnatural mouth movements, frozen, static',

  // === ADDITIONAL VIDEO MODELS ===
  'wan-pro':
    'static, frozen, blurry, low quality, distorted faces, morphing, flickering, jittery motion, bad anatomy, deformed, inconsistent character',
  'vidu-q1':
    'static, frozen, blurry, low quality, distorted, flickering, morphing, bad audio, inconsistent character',
  'vidu-q2':
    'static, frozen, blurry, low quality, distorted, flickering, morphing, inconsistent characters, identity mixing',
  'vidu-i2v':
    'static, frozen, blurry, low quality, distorted, flickering, morphing, wrong animation, identity loss',
  pixverse:
    'static, frozen, blurry, low quality, distorted, flickering, jittery motion, morphing, bad anatomy',
  magi: 'static, frozen, blurry, low quality, distorted, flickering, bad artistic style, inconsistent',
  'luma-ray-2':
    'static, frozen, blurry, low quality, distorted, flickering, glitchy, morphing, unrealistic motion',
  'luma-ray-2-i2v':
    'static, frozen, blurry, low quality, distorted, flickering, glitchy, morphing, wrong animation',
  'runway-gen3-turbo':
    'static, blurry, low quality, distorted, flickering, morphing, bad anatomy, deformed, jittery',
  'hunyuan-i2v':
    'static, frozen, blurry, low quality, distorted, flickering, morphing, wrong animation',
  'creatify-aurora':
    'blurry, distorted face, out of sync, unnatural expressions, frozen, static, identity change',
  'one-to-all-animation':
    'wrong pose, distorted, identity change, jittery motion, bad motion transfer, blurry',
  'wan-animate-move':
    'wrong motion, distorted, identity change, jittery, bad motion transfer, blurry',
  'wan-vace-inpainting':
    'visible seam, flickering, temporal inconsistency, blurry fill, mismatched lighting',
  'kling-o1-video-edit':
    'inconsistent style, flickering, temporal artifacts, wrong transformation, blurry',

  // === ADDITIONAL IMAGE MODELS ===
  'flux-pro-ultra':
    'blurry, low quality, distorted, deformed, ugly, bad anatomy, watermark, signature, text, artifacts, low resolution',
  'flux-kontext':
    'blurry, low quality, distorted, deformed, different person, identity change, inconsistent features',
