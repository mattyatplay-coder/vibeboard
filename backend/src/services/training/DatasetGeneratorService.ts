...
export const POSE_PRESETS: Record<PosePresetKey, PosePreset> = {
  ...
  pixar3d: {
    name: '3D Pixar Style',
    description:
      'Pixar/Disney 3D animation style - smooth features, expressive eyes, soft lighting. Use Jixar LoRA (ohwx trigger).',
    stylePrefix:
      '3D Pixar animation style, smooth rounded features, expressive large eyes, soft cinematic lighting',
    poses: [
  ...
  pixar3d_teen_surfer_base: {
    ...
    description:
      'BASE CHARACTER LoRA - trains identity across multiple outfits. White background. For Mylin-style teen surfer characters.',
    stylePrefix:
      '3D Pixar animation style, teenage boy, athletic lean build, messy brown hair, expressive eyes, white background',
    poses: [
      // ===========================================
  ...
  pixar3d_adult_surfer_base: {
    ...
    description:
      'BASE CHARACTER LoRA - trains identity across multiple outfits. White background. For Koa, Matt, Chase style adult surfer characters.',
    stylePrefix:
      '3D Pixar animation style, adult man, athletic muscular build, sun-kissed skin, expressive eyes, white background',
    poses: [
      // ===========================================
  ...
  pixar3d_surfer: {
    ...
    description:
      'ACTION POSES ONLY - surfing, beach, water. Use with base character LoRA. For Koa, Matt style characters.',
    stylePrefix:
      '3D Pixar animation style, surfer character, athletic build, sun-kissed skin, beach lighting, ocean environment',
    poses: [
  ...
  pixar3d_surfer_wetsuit: {
    ...
    description:
      'ACTION POSES ONLY - competition surfing, pro moves. Use with base character LoRA. For Chase Maddox style characters.',
    stylePrefix:
      '3D Pixar animation style, professional surfer character, athletic build, full black wetsuit, competitive ocean lighting',
    poses: [
  ...
  pixar3d_surfer_kid: {
    ...
    description:
      'ACTION POSES ONLY - prodigy-level surfing + areas still developing. Use with base character LoRA. For Mylin style characters.',
    stylePrefix:
      '3D Pixar animation style, teenage surfer prodigy, lean athletic build, confident youthful energy, competitive ocean lighting',
    poses: [
  ...
  pixar3d_sea_turtle: {
    ...
    description:
      'ACTION POSES ONLY - EAC current riding, tricks, expressions. Use with base turtle LoRA. Finding Nemo aesthetic.',
    stylePrefix:
      '3D Pixar animation style, sea turtle character, smooth green shell, large expressive eyes, underwater lighting with light rays, Finding Nemo aesthetic',
    poses: [
  ...
  pixar3d_aquatic: {
    ...
    description:
      'ACTION POSES ONLY - swimming, diving, jumping, interacting. Use with base aquatic LoRA. Finding Nemo/Dory style.',
    stylePrefix:
      '3D Pixar animation style, aquatic character, smooth scales or skin, expressive eyes, underwater caustic lighting',
    poses: [
  ...
  pixar3d_quadruped: {
    ...
    description:
      'ACTION POSES ONLY - running, jumping, playing, hunting. Use with base quadruped LoRA. Expressive movement.',
    stylePrefix:
      '3D Pixar animation style, quadruped animal character, expressive face, soft fur texture, warm lighting',
    poses: [
  ...
  pixar3d_avian: {
    ...
    description:
      'ACTION POSES ONLY - flying, diving, singing, hunting. Use with base bird LoRA. Dynamic wings, personality.',
    stylePrefix:
      '3D Pixar animation style, bird character, detailed feathers, expressive eyes and beak, natural lighting',
    poses: [
      // Expressions in action
  ...
  pixar3d_reptile: {
    ...
    description:
      'ACTION POSES ONLY - hunting, climbing, swimming, striking. Use with base reptile LoRA. Unique movement.',
    stylePrefix:
      '3D Pixar animation style, reptile character, detailed scales, surprisingly expressive eyes, warm basking light',
    poses: [
      // Expressions in action
...
export class DatasetGeneratorService {
  ...
  private async generateWithQwen(
    ...
    try {
      ...
      const instruction =
        `Change the pose to: ${poseInstruction}. ` +
        `Maintain the character's exact identity, face, clothing, and all physical features. ` +
        `Use a plain white background.`;

      const result = await this.falAdapter.generatePoseWithQwen(sourceUrl, instruction, {
  ...
  async generateVariations(
    ...
    const modeLabel =
      generationMode === 'hybrid'
        ...
        : generationMode === 'qwen'
          ...
          : 'Flux 2 Max';
    console.log(
      `[DatasetGenerator] ${modeEmoji} Using ${modeLabel} for ${totalPoses} pose variations (${presetName} preset)...`
    );
    ...
    for (let i = 0; i < totalPoses; i++) {
      ...
      console.log(
        `[DatasetGenerator] [${modelLabel}] ${i + 1}/${totalPoses}: "${posePrompt.substring(0, 50)}..." (${aspectRatio})`
      );
