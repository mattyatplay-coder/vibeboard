...
export const PIXAR_STORYTELLING_RULES = [
    {
        ...
        application: "Show characters struggling, failing, and persisting. The effort matters more than the outcome."
    },
    {
        rule: 2,
        title: "Audience Interest",
        description: "Keep in mind what's interesting to you as an audience, not what's fun to do as a writer.",
        application: "Always ask: would I want to watch this? Cut self-indulgent scenes."
    },
    {
        rule: 3,
        title: "Theme Discovery",
        description: "Trying for theme is important, but you won't see what the story is actually about til you're at the end of it.",
        application: "Write the draft, then refine theme in revision. Don't force meaning."
    },
    {
        rule: 4,
        title: "Story Spine",
        description: "Once upon a time there was ___. Every day, ___. One day ___. Because of that, ___. Until finally ___.",
    ...
    },
    {
        ...
        description: "Finish your story, let go even if it's not perfect. In an ideal world you have both, but move on.",
    ...
    },
    {
        rule: 11,
        title: "Write It Down",
        description: "Putting it on paper lets you start fixing it. If it stays in your head, it's a perfect idea you'll never share.",
        application: "Externalize ideas immediately. Perfect is the enemy of done."
    },
    {
        rule: 12,
        title: "Discount First Ideas",
        description: "Discount the 1st thing that comes to mind. And the 2nd, 3rd, 4th, 5th – get the obvious out of the way.",
        application: "Push past clichés. The 6th idea is usually the interesting one."
    },
    {
        rule: 13,
        title: "Give Characters Opinions",
        description: "Give your characters opinions. Passive/malleable might seem likable to you as you write, but it's poison to the audience.",
        application: "Characters must want things strongly. No wishy-washy protagonists."
    },
    {
        rule: 14,
        title: "Why This Story?",
        description: "Why must you tell THIS story? What's the belief burning within you that your story feeds off of?",
        application: "Connect to personal truth. Stories need authentic emotional cores."
    },
    {
        rule: 15,
        title: "Character Empathy",
        description: "If you were your character, in this situation, how would you feel? Honesty lends credibility.",
        application: "Feel what your characters feel. Authentic emotion resonates."
    },
    {
        rule: 16,
        title: "Stakes and Failure",
        description: "What are the stakes? Give us reason to root for the character. What happens if they don't succeed?",
        application: "Establish clear consequences. The audience must fear failure."
    },
    {
        rule: 17,
        title: "No Wasted Work",
        description: "No work is ever wasted. If it's not working, let go and move on – it'll come back around to be useful later.",
        application: "Save cut scenes. They often inspire future work."
    },
    {
        rule: 18,
        title: "Know Yourself",
        description: "You have to know yourself: the difference between doing your best & fussing. Story is testing, not refining.",
        application: "Know when to stop polishing. Testing beats perfecting."
    },
    {
        rule: 19,
        title: "Coincidence Complications",
        description: "Coincidences to get characters into trouble are great; coincidences to get them out of it are cheating.",
        application: "Characters must solve their own problems. No deus ex machina."
    },
    {
        rule: 20,
        title: "Exercise: Deconstruct Movies",
        description: "Take the building blocks of a movie you dislike. How would you rearrange them into what you DO like?",
        application: "Learn from bad examples. Reconstruction teaches structure."
    },
    {
        rule: 21,
        title: "Identify With Characters",
        description: "You gotta identify with your situation/characters, can't just write 'cool'. What would make YOU act that way?",
        application: "Ground fantastical situations in real emotion."
    },
    {
        rule: 22,
        title: "Story Essence",
        description: "What's the essence of your story? Most economical telling of it? If you know that, you can build out from there.",
...
export const DIRECTOR_STYLES: Record<string, DirectorStyle> = {
    'wes-anderson': {
        name: 'Wes Anderson',
        knownFor: ['The Grand Budapest Hotel', 'Moonrise Kingdom', 'The Royal Tenenbaums', 'Fantastic Mr. Fox', 'Isle of Dogs'],
        visualSignature: [
            'Symmetrical framing',
            'Centered subjects',
        ...
        colorPalette: [
            'Pastel pink', 'Mint green', 'Mustard yellow', 'Coral', 'Powder blue',
            'Cream', 'Terracotta', 'Burgundy', 'Seafoam', 'Mauve'
        ],
        cameraWork: [
        ...
        promptPrefix: 'Wes Anderson style, symmetrical composition, pastel color palette, centered framing, whimsical aesthetic, storybook quality,',
    ...
    'denis-villeneuve': {
        ...
        colorPalette: [
            'Orange and teal', 'Desaturated earth tones', 'Golden hour amber',
            'Cold steel blue', 'Sand beige', 'Smoke gray', 'Burnt sienna'
        ],
        cameraWork: [
        ...
        promptPrefix: 'Denis Villeneuve cinematography, epic scale, atmospheric, volumetric lighting, vast landscapes, minimalist composition,',
    ...
    'christopher-nolan': {
        ...
        colorPalette: [
            'Steel blue', 'Warm amber', 'Deep black', 'Cool gray',
            'Desaturated tones', 'High contrast'
        ],
        cameraWork: [
            'Handheld intensity',
        ...
        promptPrefix: 'Christopher Nolan style, IMAX quality, practical effects, high contrast, epic scale, cerebral intensity,',
    ...
    'david-fincher': {
        ...
        colorPalette: [
            'Sickly yellow-green', 'Cold blue', 'Muddy brown', 'Desaturated',
            'Processed colors', 'Dark shadows'
        ],
        cameraWork: [
        ...
        promptPrefix: 'David Fincher style, meticulously lit, desaturated colors, clinical precision, dark atmosphere, controlled composition,',
    ...
    'terrence-malick': {
        ...
        colorPalette: [
            'Golden hour warmth', 'Natural greens', 'Sky blues',
            'Earth tones', 'Soft pastels', 'Organic colors'
        ],
        cameraWork: [
            'Floating steadicam',
        ...
        moodKeywords: ['meditative', 'spiritual', 'lyrical', 'transcendent', 'contemplative', 'ethereal'],
        promptPrefix: 'Terrence Malick style, golden hour lighting, natural light, ethereal atmosphere, poetic composition, dreamlike quality,',
    ...
    'stanley-kubrick': {
        ...
        colorPalette: [
            'Bold primary colors', 'Clinical whites', 'Ominous reds',
            'Cold institutional tones', 'Stark contrast'
        ],
        cameraWork: [
        ...
        promptPrefix: 'Stanley Kubrick style, one-point perspective, symmetrical composition, unsettling atmosphere, clinical precision, bold colors,',
    ...
    'ridley-scott': {
        ...
        colorPalette: [
            'Blue noir', 'Golden antiquity', 'Industrial gray',
            'Amber warmth', 'Neon accents', 'Dusty earth'
        ],
        cameraWork: [
        ...
        promptPrefix: 'Ridley Scott style, atmospheric lighting, smoke and haze, epic scale, detailed environments, volumetric light shafts,',
        genres: ['Sci-Fi', 'Action', 'Drama', 'Fantasy']
    },
    'quentin-tarantino': {
        name: 'Quentin Tarantino',
        knownFor: ['Pulp Fiction', 'Kill Bill', 'Inglourious Basterds', 'Django Unchained', 'Once Upon a Time in Hollywood'],
        visualSignature: [
            '70mm film grain',
            'Chapter title cards',
            'Trunk shots',
        ...
        colorPalette: [
            'Saturated primaries', '70s browns', 'Blood red',
            'Grindhouse yellow', 'Retro warmth'
        ],
        cameraWork: [
            'Long unbroken takes',
        ...
        promptPrefix: 'Quentin Tarantino style, 70mm film grain, stylized violence, retro aesthetic, saturated colors, genre homage,',
    ...
    'wong-kar-wai': {
        ...
        colorPalette: [
            'Saturated neon', 'Rich reds', 'Deep greens', 'Midnight blue',
            'Film noir shadows', 'Warm amber'
        ],
        cameraWork: [
            'Handheld intimacy',
        ...
        promptPrefix: 'Wong Kar-wai style, neon-lit, step-printed motion, romantic melancholy, rich saturated colors, intimate framing,',
    ...
    'hayao-miyazaki': {
        ...
        colorPalette: [
            'Vibrant greens', 'Sky blues', 'Sunset oranges', 'Soft pastels',
            'Natural earth tones', 'Magical purples'
        ],
        cameraWork: [
        ...
        promptPrefix: 'Studio Ghibli style, Hayao Miyazaki, hand-drawn animation aesthetic, lush natural environments, magical realism, vibrant colors,',
    ...
    'spike-jonze': {
        ...
        colorPalette: [
            'Warm oranges', 'Soft reds', 'Cream whites', 'Muted pastels',
            'Nostalgic warmth'
        ],
        cameraWork: [
        ...
        promptPrefix: 'Spike Jonze style, warm saturated tones, intimate framing, retro-futuristic, emotional authenticity, humanistic,',
        genres: ['Drama', 'Romance', 'Comedy', 'Sci-Fi']
    },
    'coen-brothers': {
        name: 'Coen Brothers',
        knownFor: ['No Country for Old Men', 'Fargo', 'The Big Lebowski', 'True Grit', 'Inside Llewyn Davis'],
        visualSignature: [
        ...
        colorPalette: [
            'Earthy browns', 'Cold blues', 'Snowy whites', 'Desert tans',
        ...
        promptPrefix: 'Coen Brothers style, wide-angle composition, dark humor, regional authenticity, stark landscapes, precise framing,',
...
export const CINEMATOGRAPHER_STYLES: Record<string, CinematographerStyle> = {
    'roger-deakins': {
        ...
        promptKeywords: ['Roger Deakins cinematography', 'single source lighting', 'painterly', 'atmospheric', 'motivated lighting']
    },
    'emmanuel-lubezki': {
        ...
        preferredAspectRatios: ['2.39:1', '1.85:1'],
        promptKeywords: ['Lubezki cinematography', 'natural light only', 'long take', 'wide-angle', 'magic hour']
    },
    'janusz-kaminski': {
        ...
        promptKeywords: ['Kamiński cinematography', 'harsh backlight', 'bleached highlights', 'atmospheric smoke', 'God rays']
    },
    'hoyte-van-hoytema': {
        ...
        promptKeywords: ['Hoytema cinematography', 'IMAX quality', 'natural light', 'intimate epic', 'textured']
    },
    'bradford-young': {
        name: 'Bradford Young',
        ...
        preferredAspectRatios: ['2.39:1', '1.85:1'],
        promptKeywords: ['Bradford Young cinematography', 'underexposed', 'rich shadows', 'intimate portraits', 'soft diffused']
    }
};
...
export const GENRE_GUIDES: Record<string, GenreGuide> = {
    noir: {
        genre: 'Noir',
        description: 'Dark, cynical crime dramas featuring morally ambiguous protagonists, femme fatales, and shadowy urban settings.',
        ...
        lightingMoods: ['Low-key', 'Hard shadows', 'Single source', 'Silhouettes', 'Venetian blind patterns'],
        promptPrefix: 'film noir style, high contrast, deep shadows, 1940s aesthetic, rain-slicked streets, neon glow, cigarette smoke,',
        negativePrompt: 'bright, cheerful, saturated colors, daylight, happy, cartoon'
    },
    action: {
        genre: 'Action',
        description: 'High-energy films featuring physical feats, combat, chases, and explosive set pieces.',
        storytellingConventions: [
        ...
        archetypes: ['Reluctant hero', 'Sidekick', 'Mastermind villain', 'Love interest in danger', 'Mentor figure'],
        ...
        promptPrefix: 'action movie style, dynamic composition, high energy, dramatic lighting, epic scale, cinematic,',
        negativePrompt: 'static, boring, peaceful, slow, mundane'
    },
    horror: {
        genre: 'Horror',
        description: 'Films designed to frighten and unsettle through supernatural or psychological threats.',
        storytellingConventions: [
            'Isolated setting',
            'Warnings ignored',
            'Escalating dread',
        ...
        promptPrefix: 'horror movie style, unsettling atmosphere, deep shadows, creepy, ominous lighting, dread,',
    ...
    romance: {
        ...
        archetypes: ['Star-crossed lovers', 'Best friend love interest', 'Rival for affection', 'Wise friend', 'Disapproving parent'],
        ...
        promptPrefix: 'romantic movie style, soft lighting, warm tones, intimate, beautiful, emotional, golden hour,',
        negativePrompt: 'harsh, cold, violent, scary, industrial, ugly'
    },
    'sci-fi': {
        genre: 'Sci-Fi',
        description: 'Speculative fiction exploring futuristic technology, space, time, and humanity\'s relationship with science.',
        storytellingConventions: [
        ...
        archetypes: ['Scientist hero', 'AI companion', 'Corporate villain', 'Alien other', 'Chosen one'],
        emotionalBeats: ['Wonder', 'Discovery', 'Existential dread', 'Hope', 'Transcendence'],
        suggestedDirectors: ['denis-villeneuve', 'christopher-nolan', 'ridley-scott', 'stanley-kubrick'],
        suggestedCinematographers: ['roger-deakins', 'hoyte-van-hoytema'],
        colorPalette: ['Steel blue', 'Neon accents', 'Space black', 'Holographic', 'Orange/teal contrast'],
        lightingMoods: ['Volumetric', 'Neon glow', 'Starlight', 'Laboratory', 'Alien atmospheres'],
        promptPrefix: 'science fiction style, futuristic, cinematic, epic scale, advanced technology, atmospheric,',
    ...
    comedy: {
        ...
        archetypes: ['Lovable loser', 'Straight man', 'Wild card', 'Authority figure to undermine', 'Love interest'],
    ...
    thriller: {
        genre: 'Thriller',
        description: 'Suspenseful films that keep audiences on edge through tension, mystery, and psychological stakes.',
        storytellingConventions: [
            'Mystery to unravel',
            'Red herrings',
        ...
        archetypes: ['Ordinary person in danger', 'Unreliable narrator', 'Hidden villain', 'Helpful stranger', 'Authority figure'],
        ...
        suggestedCinematographers: ['roger-deakins', 'bradford-young'],
        colorPalette: ['Desaturated', 'Cold blues', 'Sickly yellows', 'Clinical whites', 'Shadow blacks'],
        lightingMoods: ['Low-key', 'Motivated practical', 'Surveillance harsh', 'Interrogation style'],
        promptPrefix: 'thriller style, suspenseful atmosphere, tense, shadows, paranoid mood, cinematic,',
        negativePrompt: 'cheerful, bright, safe, comfortable, relaxed, cartoon'
    },
    drama: {
        genre: 'Drama',
        description: 'Character-driven stories exploring human emotion, relationships, and meaningful themes.',
        storytellingConventions: [
        ...
        archetypes: ['Flawed protagonist', 'Supporting confidant', 'Antagonist representing obstacle', 'Mentor', 'Love interest'],
        ...
        lightingMoods: ['Natural light', 'Soft and flattering', 'Emotional contrast', 'Time of day as mood'],
        promptPrefix: 'dramatic cinematography, emotional lighting, intimate framing, naturalistic, character-focused,',
        negativePrompt: 'action-packed, flashy, exaggerated, cartoon, superficial'
    },
    western: {
        genre: 'Western',
        description: 'Stories set in the American Old West featuring frontier justice, outlaws, and wilderness.',
        storytellingConventions: [
        ...
        archetypes: ['Lone gunslinger', 'Corrupt sheriff', 'Innocent settler', 'Outlaw gang', 'Native American'],
        ...
        promptPrefix: 'western movie style, vast landscapes, dusty atmosphere, golden hour, cinematic wide shots,',
        negativePrompt: 'urban, modern, technology, futuristic, green, lush'
    },
    fantasy: {
        genre: 'Fantasy',
        description: 'Stories featuring magical elements, mythical creatures, and otherworldly settings.',
        storytellingConventions: [
        ...
        lightingMoods: ['Magical glow', 'Ethereal', 'Dramatic contrast', 'Forest dappled', 'Torchlight'],
        promptPrefix: 'fantasy movie style, magical atmosphere, epic scale, mystical lighting, otherworldly,',
    ...
    documentary: {
        ...
        lightingMoods: ['Natural available', 'Interview key light', 'Observational', 'Real environments'],
    ...
    animation: {
        genre: 'Animation',
        description: 'Films created through animation techniques, often featuring stylized worlds and characters.',
        storytellingConventions: [
        ...
        colorPalette: ['Vibrant primaries', 'Rich saturated', 'Stylized palettes', 'Emotional color shifts'],
        lightingMoods: ['Stylized', 'Dramatic for effect', 'Soft and appealing', 'Magical glow'],
        promptPrefix: 'animated movie style, vibrant colors, expressive, stylized, cinematic animation,',
    ...
    musical: {
        ...
        archetypes: ['Dreamer protagonist', 'Love interest', 'Villain with a song', 'Comic ensemble', 'Mentor'],
        ...
        promptPrefix: 'musical movie style, theatrical, colorful, expressive, dynamic staging, cinematic,',
    ...
    commercial: {
        ...
        archetypes: ['Aspirational user', 'Product as hero', 'Brand spokesperson', 'Satisfied customer'],
        ...
        promptPrefix: 'commercial photography style, perfect lighting, polished, aspirational, product-focused,',
    ...
    adult: {
        ...
        description: 'Intimate, sensual content for mature audiences. Glamour and boudoir aesthetics with tasteful cinematography.',
        storytellingConventions: [
        ...
        archetypes: ['The Temptress/Seducer', 'The Innocent', 'The Voyeur', 'The Dominant', 'The Submissive', 'Fantasy Partner'],
        emotionalBeats: ['Attraction', 'Tension', 'Desire', 'Surrender', 'Ecstasy', 'Afterglow'],
        suggestedDirectors: ['wong-kar-wai', 'terrence-malick'],
        suggestedCinematographers: ['emmanuel-lubezki', 'bradford-young'],
        colorPalette: ['Warm golden', 'Deep crimson', 'Soft pink', 'Midnight purple', 'Candlelight amber'],
        lightingMoods: ['Candlelight', 'Golden hour', 'Low-key intimate', 'Rim light silhouettes', 'Soft diffused'],
        promptPrefix: 'intimate boudoir photography, sensual lighting, glamour aesthetic, soft focus, romantic atmosphere, tasteful, artistic,',
        negativePrompt: 'harsh lighting, documentary style, unflattering angles, clinical, cold, aggressive, violent'
    },
    hardcore: {
        genre: 'XXX / Hardcore',
        description: 'Explicit XXX pornographic content with graphic sexual acts. Professional adult film production with clear visibility of all action.',
        storytellingConventions: [
        ...
        archetypes: ['The MILF', 'The Stepdaughter', 'The Pizza Guy', 'The Casting Director', 'The Pool Boy', 'The Massage Therapist', 'The Babysitter'],
        emotionalBeats: ['Setup/Scenario', 'Seduction', 'Foreplay', 'Oral', 'Penetration', 'Position Changes', 'Build to Climax', 'Money Shot'],
        ...
        colorPalette: ['Warm skin tones', 'High contrast', 'Natural daylight', 'Studio white', 'Ring light glow'],
        lightingMoods: ['High-key studio', 'Ring light beauty', 'Overhead practical', 'Natural window', 'Bright and clear'],
        promptPrefix: 'XXX pornographic film, explicit graphic sexual content, clear genital visibility, penetration close-up, money shot, professional adult production, hardcore,',
        negativePrompt: 'dark shadows, blurry genitals, poor quality, obscured action, soft focus, censored, pixelated'
    }
};
 ...
 */
export function getCinematographerStyle(cinematographerKey: string): CinematographerStyle | undefined {
 ...
 */
export function getPixarRulesForSituation(situation: string): typeof PIXAR_STORYTELLING_RULES[0][] {
