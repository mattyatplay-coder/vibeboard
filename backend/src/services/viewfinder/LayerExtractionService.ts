...
export interface FramingPreset {
    ...
    cropRegion: {             // Normalized crop for framing
        top: number;          // 0-1
        bottom: number;       // 0-1
    };
}
...
export const CAMERA_DATABASE: CameraModel[] = [
    // Full Frame (35mm)
    { id: 'sony-a7iv', brand: 'Sony', model: 'A7 IV', sensorSize: 'full-frame', sensorWidth: 35.7, sensorHeight: 23.8, cropFactor: 1.0, megapixels: 33, circleOfConfusion: 0.030, year: 2021 },
    { id: 'sony-a7siii', brand: 'Sony', model: 'A7S III', sensorSize: 'full-frame', sensorWidth: 35.6, sensorHeight: 23.8, cropFactor: 1.0, megapixels: 12.1, circleOfConfusion: 0.030, year: 2020 },
    { id: 'sony-fx3', brand: 'Sony', model: 'FX3', sensorSize: 'full-frame', sensorWidth: 35.6, sensorHeight: 23.8, cropFactor: 1.0, megapixels: 12.1, circleOfConfusion: 0.030, year: 2021 },
    { id: 'canon-r5', brand: 'Canon', model: 'EOS R5', sensorSize: 'full-frame', sensorWidth: 36.0, sensorHeight: 24.0, cropFactor: 1.0, megapixels: 45, circleOfConfusion: 0.030, year: 2020 },
    { id: 'canon-r6ii', brand: 'Canon', model: 'EOS R6 Mark II', sensorSize: 'full-frame', sensorWidth: 36.0, sensorHeight: 24.0, cropFactor: 1.0, megapixels: 24.2, circleOfConfusion: 0.030, year: 2022 },
    { id: 'nikon-z8', brand: 'Nikon', model: 'Z8', sensorSize: 'full-frame', sensorWidth: 35.9, sensorHeight: 23.9, cropFactor: 1.0, megapixels: 45.7, circleOfConfusion: 0.030, year: 2023 },
    { id: 'nikon-z6iii', brand: 'Nikon', model: 'Z6 III', sensorSize: 'full-frame', sensorWidth: 35.9, sensorHeight: 23.9, cropFactor: 1.0, megapixels: 24.5, circleOfConfusion: 0.030, year: 2024 },
    { id: 'panasonic-s5ii', brand: 'Panasonic', model: 'Lumix S5 II', sensorSize: 'full-frame', sensorWidth: 35.6, sensorHeight: 23.8, cropFactor: 1.0, megapixels: 24.2, circleOfConfusion: 0.030, year: 2023 },
    { id: 'red-v-raptor', brand: 'RED', model: 'V-RAPTOR', sensorSize: 'full-frame', sensorWidth: 40.96, sensorHeight: 21.60, cropFactor: 0.88, megapixels: 35.4, circleOfConfusion: 0.034, year: 2021 },
    { id: 'arri-alexa35', brand: 'ARRI', model: 'ALEXA 35', sensorSize: 'full-frame', sensorWidth: 27.99, sensorHeight: 19.22, cropFactor: 1.29, megapixels: 4.6, circleOfConfusion: 0.023, year: 2022 },

    // APS-C
    { id: 'sony-a6700', brand: 'Sony', model: 'A6700', sensorSize: 'aps-c', sensorWidth: 23.5, sensorHeight: 15.6, cropFactor: 1.5, megapixels: 26, circleOfConfusion: 0.020, year: 2023 },
    { id: 'sony-fx30', brand: 'Sony', model: 'FX30', sensorSize: 'aps-c', sensorWidth: 23.4, sensorHeight: 15.6, cropFactor: 1.53, megapixels: 20.1, circleOfConfusion: 0.020, year: 2022 },
    { id: 'fuji-xh2s', brand: 'Fujifilm', model: 'X-H2S', sensorSize: 'aps-c', sensorWidth: 23.5, sensorHeight: 15.6, cropFactor: 1.5, megapixels: 26.2, circleOfConfusion: 0.020, year: 2022 },
    { id: 'fuji-xt5', brand: 'Fujifilm', model: 'X-T5', sensorSize: 'aps-c', sensorWidth: 23.5, sensorHeight: 15.6, cropFactor: 1.5, megapixels: 40.2, circleOfConfusion: 0.020, year: 2022 },
    { id: 'canon-r7', brand: 'Canon', model: 'EOS R7', sensorSize: 'aps-c', sensorWidth: 22.3, sensorHeight: 14.8, cropFactor: 1.6, megapixels: 32.5, circleOfConfusion: 0.019, year: 2022 },
    { id: 'nikon-z50ii', brand: 'Nikon', model: 'Z50 II', sensorSize: 'aps-c', sensorWidth: 23.5, sensorHeight: 15.7, cropFactor: 1.5, megapixels: 20.9, circleOfConfusion: 0.020, year: 2024 },

    // Micro Four Thirds
    { id: 'panasonic-gh6', brand: 'Panasonic', model: 'Lumix GH6', sensorSize: 'micro-four-thirds', sensorWidth: 17.3, sensorHeight: 13.0, cropFactor: 2.0, megapixels: 25.2, circleOfConfusion: 0.015, year: 2022 },
    { id: 'panasonic-gh7', brand: 'Panasonic', model: 'Lumix GH7', sensorSize: 'micro-four-thirds', sensorWidth: 17.3, sensorHeight: 13.0, cropFactor: 2.0, megapixels: 25.2, circleOfConfusion: 0.015, year: 2024 },
    { id: 'om-om1ii', brand: 'OM System', model: 'OM-1 Mark II', sensorSize: 'micro-four-thirds', sensorWidth: 17.4, sensorHeight: 13.0, cropFactor: 2.0, megapixels: 20.4, circleOfConfusion: 0.015, year: 2024 },
    { id: 'bmpcc-6k', brand: 'Blackmagic', model: 'Pocket Cinema 6K', sensorSize: 'aps-c', sensorWidth: 23.1, sensorHeight: 12.99, cropFactor: 1.56, megapixels: 21.2, circleOfConfusion: 0.020, year: 2019 },

    // Medium Format
    { id: 'fuji-gfx100ii', brand: 'Fujifilm', model: 'GFX100 II', sensorSize: 'medium-format', sensorWidth: 43.8, sensorHeight: 32.9, cropFactor: 0.79, megapixels: 102, circleOfConfusion: 0.038, year: 2023 },
    { id: 'hasselblad-x2d', brand: 'Hasselblad', model: 'X2D 100C', sensorSize: 'medium-format', sensorWidth: 43.8, sensorHeight: 32.9, cropFactor: 0.79, megapixels: 100, circleOfConfusion: 0.038, year: 2022 },
    { id: 'phaseone-iq4', brand: 'Phase One', model: 'IQ4 150MP', sensorSize: 'medium-format', sensorWidth: 53.4, sensorHeight: 40.0, cropFactor: 0.65, megapixels: 151, circleOfConfusion: 0.046, year: 2019 },

    // Smartphones (for reference)
    { id: 'iphone-15-pro', brand: 'Apple', model: 'iPhone 15 Pro', sensorSize: 'one-inch', sensorWidth: 9.8, sensorHeight: 7.3, cropFactor: 3.67, megapixels: 48, circleOfConfusion: 0.008, year: 2023 },
    { id: 'iphone-16-pro', brand: 'Apple', model: 'iPhone 16 Pro', sensorSize: 'one-inch', sensorWidth: 9.8, sensorHeight: 7.3, cropFactor: 3.67, megapixels: 48, circleOfConfusion: 0.008, year: 2024 },
    { id: 'samsung-s24ultra', brand: 'Samsung', model: 'Galaxy S24 Ultra', sensorSize: 'one-inch', sensorWidth: 8.6, sensorHeight: 6.4, cropFactor: 4.19, megapixels: 200, circleOfConfusion: 0.007, year: 2024 },
];

/** Stand-in model silhouettes for DOF preview */
export const STAND_IN_MODELS: StandInModel[] = [
    { id: 'woman-170', name: 'Woman (170cm)', type: 'woman', heightCm: 170, silhouetteUrl: '/viewfinder/silhouettes/woman-170.png', thumbnailUrl: '/viewfinder/silhouettes/woman-170-thumb.png' },
    { id: 'woman-165', name: 'Woman (165cm)', type: 'woman', heightCm: 165, silhouetteUrl: '/viewfinder/silhouettes/woman-165.png', thumbnailUrl: '/viewfinder/silhouettes/woman-165-thumb.png' },
    { id: 'man-180', name: 'Man (180cm)', type: 'man', heightCm: 180, silhouetteUrl: '/viewfinder/silhouettes/man-180.png', thumbnailUrl: '/viewfinder/silhouettes/man-180-thumb.png' },
    { id: 'man-175', name: 'Man (175cm)', type: 'man', heightCm: 175, silhouetteUrl: '/viewfinder/silhouettes/man-175.png', thumbnailUrl: '/viewfinder/silhouettes/man-175-thumb.png' },
    { id: 'child-120', name: 'Child (120cm)', type: 'child', heightCm: 120, silhouetteUrl: '/viewfinder/silhouettes/child-120.png', thumbnailUrl: '/viewfinder/silhouettes/child-120-thumb.png' },
    { id: 'silhouette-generic', name: 'Generic Silhouette', type: 'silhouette', heightCm: 170, silhouetteUrl: '/viewfinder/silhouettes/generic.png', thumbnailUrl: '/viewfinder/silhouettes/generic-thumb.png' },
];
...
export class LayerExtractionService {
    ...
    async extractLayers(options: LayerExtractionOptions): Promise<LayerExtractionResult> {
        ...
        try {
            ...
            log.info?.({ imageUrl: publicImageUrl, numLayers }, 'Extracting layers with fal-ai/qwen-image-layered');
    ...
    getCamerasByBrand(): Record<string, CameraModel[]> {
        return CAMERA_DATABASE.reduce((acc, camera) => {
            if (!acc[camera.brand]) {
                acc[camera.brand] = [];
            }
