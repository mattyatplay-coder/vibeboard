            ...
            {!selectedChainId ? (
                <>
                    ...
                    <Typography variant="body1" color="text.secondary" sx={{ mb: 4 }}>
                        Create scene chains to sequence multiple video generations with consistent characters and style.
                        Each segment builds on the previous one, creating seamless video narratives.
                    </Typography>
