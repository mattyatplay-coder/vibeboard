...
const GENRE_IR_OPTIONS = [
  {
    ...
    genre: 'sci-fi',
    label: 'Metallic Hall',
    description: 'Cold, spaceship corridors',
  },
      ...
      <div className="relative">
        <input
          ...
          className={clsx(
            ...
            'focus:ring-2 focus:ring-cyan-500/30 focus:outline-none',
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 space-y-6 overflow-y-auto p-4">
        ...
        <div className="space-y-4">
          <h3 className="flex items-center gap-2 text-xs font-bold text-zinc-400 uppercase">
        ...
        <div className="space-y-4">
          ...
          <p className="text-[10px] text-zinc-600">
            Balance between ambient sounds (wind, room tone) and action foley (footsteps, impacts).
          </p>
        </div>
                  ...
                  {GENRE_IR_OPTIONS.map(ir => (
                    <button
                      ...
                      className={clsx(
                        ...
                        selectedIR === ir.id ? 'bg-cyan-500/20' : 'hover:bg-white/5'
                      )}
                    >
                      <span className="text-sm text-white">{ir.label}</span>
                      <span className="text-[10px] text-zinc-500">{ir.description}</span>
                    </button>
                  ))}
                </motion.div>
              )}
      ...
      <div className="border-t border-white/10 bg-black/30 p-4">
        <div className="flex items-center justify-between">
          <div>
            <span className="text-[10px] font-bold text-zinc-500 uppercase">Acoustic Profile</span>
            <p className="font-mono text-sm text-white">{lensPreset.description}</p>
          </div>
          <div className="text-right">
            <span className="text-[10px] font-bold text-zinc-500 uppercase">Focal</span>
