...
export default function Step4Review() {
    ...
    }, [state.initialPrompt, state.selectedEngine, state.selectedTags, state.enhancedPrompt, dispatch]);
    ...
    return (
        <Box>
            ...
            <Typography variant="body1" color="text.secondary" paragraph>
                We've constructed a professional prompt based on your inputs. Review the details and adjust the motion settings.
            </Typography>
