...
export default function Step3ChooseEngine() {
    ...
    const [recommendation, setRecommendation] = useState<ReturnType<typeof recommendEngine> | null>(null);
    ...
    return (
        <Box>
            ...
            <Typography variant="body1" color="text.secondary" paragraph>
                Select the AI model that best fits your vision. We've analyzed your prompt and tags to provide a recommendation.
            </Typography>
                ...
                >
                    <CardContent>
                        ...
                        <Box display="flex" gap={2} flexWrap="wrap">
                            ...
                            <Chip label={`Est. Cost: ${recommendation.estimatedCost} credits`} size="small" variant="outlined" />
                        </Box>
                    </CardContent>
                    <CardActions sx={{ justifyContent: 'flex-end', p: 2 }}>
                        ...
                        >
                            {state.selectedEngine?.id === recommendation.engine.id ? 'Selected' : 'Select Recommended'}
                        </Button>
                    </CardActions>
                </Card>
            )}
                        ...
                        >
                            <CardContent sx={{ flexGrow: 1 }}>
                                <Box display="flex" justifyContent="space-between" alignItems="start">
                                    ...
                                    {state.selectedEngine?.id === engine.id && (
