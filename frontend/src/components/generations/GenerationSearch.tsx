                            ...
                            {[
                              ...
                              >
                                <input
                                  ...
                                  onChange={() =>
                                    updateSortFilter({ sortOrder: opt.value as SortOrder })
                                  }
                                  className="rounded border-white/20 bg-black/50 text-blue-500 focus:ring-blue-500/50"
                                />
                                <span
                          ...
                          <div className="space-y-1">
                            {[
                              ...
                              >
                                <input
                                  type="checkbox"
                                  checked={sortFilter.filterMediaType.includes(
                                    opt.value as 'image' | 'video'
                                  )}
                                  onChange={() =>
                                    toggleFilter('filterMediaType', opt.value as 'image' | 'video')
                                  }
                                  className="rounded border-white/20 bg-black/50 text-blue-500 focus:ring-blue-500/50"
                                />
