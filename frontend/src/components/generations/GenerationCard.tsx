...
import { Heart, Download, Trash2, X, Play, Loader2, Sparkles, Check, Maximize2, ZoomIn, FilePlus, Wand2, AlertTriangle, Lightbulb, Paintbrush, Film, ThumbsUp, ThumbsDown } from "lucide-react";
                ...
                >
                    {onToggleSelection && (
                        <div
                            ...
                            className={clsx(
                                "w-[clamp(20px,7%,32px)] aspect-square rounded border-2 flex items-center justify-center transition-colors cursor-pointer backdrop-blur-sm",
                                isSelected
                                    ? "bg-blue-500 border-blue-500"
                                    : "bg-black/40 border-white/60 hover:border-white hover:bg-black/60"
                            )}
                        >
                            {isSelected && <Check className="w-[65%] h-[65%] text-white" />}
                        </div>
                    )}
                    {generation.status === 'succeeded' && (
                        <button
                            ...
                            className={clsx(
                                "w-[clamp(20px,7%,32px)] aspect-square rounded flex items-center justify-center transition-colors backdrop-blur-sm",
                                generation.isFavorite ? "bg-red-500/80" : "bg-black/40 hover:bg-red-500/50"
                            )}
                        >
                            <Heart className={clsx("w-[65%] h-[65%]", generation.isFavorite ? "fill-white text-white" : "text-white")} />
                        </button>
                    )}
                </div>
                ...
                >
                    ...
                    {generation.status === 'succeeded' && (
                        <button
                            ...
                            className="w-[clamp(24px,8%,40px)] aspect-square rounded bg-black/50 hover:bg-white/20 flex items-center justify-center transition-colors backdrop-blur-sm"
                            title="Fullscreen"
                    ...
                    {generation.status === 'succeeded' && !isVideo && onUpscale && (
                        <div className="relative">
                            <button
                                ...
                                className="w-[clamp(24px,8%,40px)] aspect-square rounded bg-green-600/80 hover:bg-green-500 flex items-center justify-center transition-colors backdrop-blur-sm"
                                title="Upscale"
                    ...
                    {generation.status === 'succeeded' && !isVideo && onAnimate && (
                        <button
                            ...
                            className="w-[clamp(24px,8%,40px)] aspect-square rounded bg-purple-600/80 hover:bg-purple-500 flex items-center justify-center transition-colors backdrop-blur-sm"
                            title="Animate"
                    ...
                    {generation.status === 'succeeded' && isVideo && onEnhanceVideo && (
                        <div className="relative">
                            <button
                                ...
                                className="w-[clamp(24px,8%,40px)] aspect-square rounded bg-gradient-to-r from-purple-600/80 to-pink-600/80 hover:from-purple-500 hover:to-pink-500 flex items-center justify-center transition-colors backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-purple-400"
                    ...
                    {generation.status === 'succeeded' && !isVideo && mediaUrl && (
                        <button
                            ...
                            className="w-[clamp(24px,8%,40px)] aspect-square rounded bg-orange-600/80 hover:bg-orange-500 flex items-center justify-center transition-colors backdrop-blur-sm"
                            title="Roto & Paint"
                    ...
                    {generation.status === 'succeeded' && isVideo && mediaUrl && (
                        <button
                            ...
                            className="w-[clamp(24px,8%,40px)] aspect-square rounded bg-cyan-600/80 hover:bg-cyan-500 flex items-center justify-center transition-colors backdrop-blur-sm"
                            title="Rotoscope"
                    ...
                    {generation.status === 'succeeded' && onSaveAsElement && (
                        <button
                            ...
                            className="w-[clamp(24px,8%,40px)] aspect-square rounded bg-black/50 hover:bg-blue-500/50 flex items-center justify-center transition-colors backdrop-blur-sm"
                    ...
                    <button
                        ...
                        className="w-[clamp(24px,8%,40px)] aspect-square rounded bg-black/50 hover:bg-red-500/50 flex items-center justify-center transition-colors backdrop-blur-sm"
                        title="Delete"
