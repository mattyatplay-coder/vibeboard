      ...
      <div className="relative aspect-video overflow-hidden rounded border border-white/10 bg-black/60">
        {referenceImageUrl ? (
          <img
            ...
            style={{
              transform:
                mode === 'constant-framing' ? `scale(${dollyZoomPreview.backgroundScale})` : 'none',
          ...
          <div className="flex h-full items-center justify-center">
            <div className="relative">
              {/* Subject placeholder */}
              <div
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-cyan-500 bg-cyan-500/20"
                style={{
        ...
        <div className="absolute right-2 bottom-2 rounded bg-black/70 px-1.5 py-0.5 text-[9px] text-white">
