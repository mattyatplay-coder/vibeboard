...
import { Loader2, Upload, Brush, Undo2, Video, Wand2, ChevronDown, ChevronUp, Settings2, Download, Scissors, Eraser, ZoomIn, ZoomOut, Maximize2 } from 'lucide-react';
            ...
            <div className="flex-1 flex gap-8 min-h-0">
                ...
                <div className="w-64 space-y-6 flex-none">
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-gray-400 block">Video</label>
                        <label className="border border-dashed border-white/20 rounded-lg p-4 flex flex-col items-center justify-center cursor-pointer hover:bg-white/5 transition-colors h-32 relative">
                            ...
                            <span className="text-xs text-gray-400 text-center z-10">
                                {videoFile ? 'Change Video' : 'Upload Video'}
                            </span>
                            <span className="text-[10px] text-gray-500 z-10">MP4, WebM, MOV</span>
                        ...
                        <div className="space-y-4 p-4 bg-black/20 rounded-lg border border-white/5">
                            ...
                            <div className="space-y-1">
                                ...
                                <input
                                    ...
                                    className="w-full bg-black/30 border border-white/10 rounded px-2 py-1.5 text-xs text-white placeholder:text-gray-600"
                                />
                            </div>
                            ...
                            <button
                                ...
                                className="w-full py-1.5 rounded text-xs text-gray-400 hover:text-gray-300 flex items-center justify-center gap-1 bg-white/5 hover:bg-white/10"
                            >
                            ...
                            <button
                                ...
                                className="w-full py-3 bg-purple-600 hover:bg-purple-500 disabled:bg-gray-600 text-white font-bold rounded text-sm flex items-center justify-center gap-2"
                            >
                                {isProcessing ? (
                                    <>
                            ...
                            {resultVideoUrl && (
                                <button
                                    ...
                                    className="w-full py-2 bg-green-600 hover:bg-green-500 text-white rounded text-xs font-bold flex items-center justify-center gap-1"
                                >
                    ...
                    <div className="text-xs text-gray-500 space-y-1">
                        ...
                        <p>2. <span className="text-purple-400">Paint over the object</span> to remove on the first frame</p>
                ...
                <div ref={containerRef} className="flex-1 bg-black/40 rounded-lg overflow-auto border border-white/10 relative select-none">
                    ...
                    {!firstFrame && !isExtracting && (
                        <div className="absolute inset-0 flex items-center justify-center">
                            <p className="text-gray-600 text-sm">Upload a video to start editing</p>
                        </div>
                    )}
                    ...
                    {isExtracting && (
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="text-center">
                                ...
                                <p className="text-gray-400 text-sm">Extracting first frame...</p>
                            </div>
                        </div>
                    )}
                    ...
                    {firstFrame && !isExtracting && (
                        <div className="inline-block p-4">
                            ...
                            >
                                ...
                                <div
                                    ref={cursorRef}
                                    className="absolute rounded-full border-2 border-white bg-purple-500/30 pointer-events-none z-10"
                                    style={{
                                        width: brushSize,
                                        height: brushSize,
                                        display: 'none',
