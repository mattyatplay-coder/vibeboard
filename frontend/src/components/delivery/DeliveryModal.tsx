              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">
                    Upload your video with AI-optimized metadata
                  </p>
                </div>
              </div>
              <button
            ...
            <div className="max-h-[70vh] overflow-y-auto p-4">
              ...
              {isConnected && (
                <>
                  ...
                  {/* Tags */}
                  <div className="mb-4">
                    <label className="mb-2 block text-xs font-medium text-gray-400">Tags</label>
                    <div className="flex flex-wrap gap-2">
                      {tags.map((tag, i) => (
                        <span
                          key={i}
                  ...
                  {/* Privacy Settings */}
                  <div className="mb-4">
                    <label className="mb-2 block text-xs font-medium text-gray-400">Privacy</label>
