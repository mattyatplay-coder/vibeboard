...
export const GENRE_TEMPLATES: Record<Genre, GenreTemplate> = {
    ...
    adult: {
        ...
        recommendedTags: [
            'glam', 'beauty_lighting', 'soft_focus', 'bokeh', 'rim_light',
            'dolly_in', 'arc_left', 'arc_right', 'close_up', 'eyes_in',
            'warm_golden', 'pastel_dream', 'low_key', 'candlelight',
            'intimate', 'sensual', 'romantic', 'dreamy', 'seductive'
        ],
        avoidedTags: ['dutch_angle', 'shaky_intense', 'horror', 'aggressive', 'documentary'],
        defaultStyle: 'intimate boudoir, sensual lighting, glamour photography, soft focus, romantic atmosphere',
    ...
    hardcore: {
        ...
        name: 'XXX / Hardcore',
        icon: '🔥',
        description: 'Explicit XXX adult content. Graphic sexual acts with professional pornographic production values.',
        recommendedTags: [
            'extreme_close_up', 'pov', 'gonzo', 'handheld', 'tracking_shot',
            'low_angle', 'high_angle', 'reverse_angle', 'two_shot', 'three_shot',
            'high_key', 'ring_light', 'practical_lights', 'overhead',
            'explicit', 'graphic', 'raw', 'intense', 'primal', 'uninhibited'
        ],
        avoidedTags: ['horror', 'dutch_angle', 'desaturated', 'cold_steel', 'noir', 'soft_focus'],
        defaultStyle: 'XXX pornographic film, explicit graphic content, clear genital visibility, money shot coverage, professional adult production',
        colorPalette: ['#FF1744', '#D50000', '#FF6D00', '#000000', '#FFFFFF'],
        cameraPreferences: ['POV', 'Extreme Close Up', 'Gonzo', 'Reverse Cowgirl Angle', 'Missionary Angle', 'Doggy Angle'],
        styleNotes: [
 ...
 */
export function getGenreOptions(includeMature: boolean = false): { value: Genre; label: string; icon: string }[] {
