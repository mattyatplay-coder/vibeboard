...
export const MODEL_PRICING: Record<string, ModelPrice> = {
    ...
    'fal-ai/ideogram/character': { perImage: 0.10 },
    ...
    'fal-ai/kling-video/v2.1/master/text-to-video': { perSecond: 0.10 },
    'fal-ai/kling-video/v2.6/pro/text-to-video': { perSecond: 0.12 },
    'fal-ai/vidu/q1/text-to-video': { perSecond: 0.08 },
    'fal-ai/vidu/q2/reference-to-video': { perSecond: 0.10 },
    ...
    'fal-ai/veo3': { perSecond: 0.40 },
    'fal-ai/pixverse/v4.5/text-to-video': { perSecond: 0.06 },
    'fal-ai/magi': { basePrice: 0.80, perSecond: 0.20 },
    ...
    'fal-ai/kling-video/v2.1/master/image-to-video': { perSecond: 0.10 },
    ...
    'fal-ai/runway-gen3/turbo/image-to-video': { perSecond: 0.10 },
    ...
    'fal-ai/creatify/aurora': { perSecond: 0.10 },
    ...
    'veo-3': { perSecond: 0.40 },

    // === OPENAI ===
    'dall-e-3': { perImage: 0.04 },
    'gpt-image-1': { perImage: 0.05 },
    'sora-2-pro': { perSecond: 0.50 },
    'sora-2': { perSecond: 0.30 },
    'sora': { perSecond: 0.20 },
