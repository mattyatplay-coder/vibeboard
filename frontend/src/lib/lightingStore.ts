...
export const LIGHTING_PRESETS: LightingPreset[] = [
    {
        ...
        lights: [
            { type: 'key', name: 'Key Light', x: 0.25, y: 0.3, intensity: 100, colorTemp: 5600, softness: 30, enabled: true },
            { type: 'fill', name: 'Fill Light', x: 0.75, y: 0.35, intensity: 50, colorTemp: 5600, softness: 60, enabled: true },
            { type: 'back', name: 'Back Light', x: 0.5, y: 0.1, intensity: 70, colorTemp: 5600, softness: 20, enabled: true },
        ]
    },
    {
        id: 'noir',
        ...
        lights: [
            { type: 'key', name: 'Key Light', x: 0.15, y: 0.25, intensity: 100, colorTemp: 4000, softness: 10, enabled: true },
            { type: 'rim', name: 'Rim Light', x: 0.85, y: 0.15, intensity: 60, colorTemp: 5600, softness: 15, enabled: true },
        ]
    },
    {
        id: 'soft-beauty',
        ...
        lights: [
            { type: 'key', name: 'Key Light', x: 0.5, y: 0.2, intensity: 80, colorTemp: 5200, softness: 90, enabled: true },
            { type: 'fill', name: 'Fill Left', x: 0.2, y: 0.4, intensity: 60, colorTemp: 5200, softness: 80, enabled: true },
            { type: 'fill', name: 'Fill Right', x: 0.8, y: 0.4, intensity: 60, colorTemp: 5200, softness: 80, enabled: true },
        ]
    },
    {
        id: 'golden-hour',
        ...
        lights: [
            { type: 'key', name: 'Sun', x: 0.1, y: 0.2, intensity: 100, colorTemp: 3200, softness: 40, enabled: true },
            { type: 'ambient', name: 'Ambient Fill', x: 0.5, y: 0.5, intensity: 30, colorTemp: 6500, softness: 100, enabled: true },
        ]
    },
    {
        id: 'rembrandt',
        ...
        lights: [
            { type: 'key', name: 'Key Light', x: 0.2, y: 0.25, intensity: 100, colorTemp: 5000, softness: 25, enabled: true },
            { type: 'fill', name: 'Subtle Fill', x: 0.8, y: 0.5, intensity: 20, colorTemp: 5000, softness: 70, enabled: true },
        ]
    },
    {
        id: 'neon-cyberpunk',
        ...
        lights: [
            { type: 'practical', name: 'Neon Pink', x: 0.15, y: 0.3, intensity: 80, colorTemp: 5600, softness: 50, enabled: true, useGel: true, gelColor: '#ff00ff', distance: 0.4 },
            { type: 'practical', name: 'Neon Cyan', x: 0.85, y: 0.35, intensity: 80, colorTemp: 5600, softness: 50, enabled: true, useGel: true, gelColor: '#00ffff', distance: 0.4 },
            { type: 'ambient', name: 'Dark Ambient', x: 0.5, y: 0.5, intensity: 10, colorTemp: 5600, softness: 100, enabled: true, useGel: false, gelColor: '#ffffff', distance: 0.5 },
        ]
    },
    {
        id: 'horror',
        ...
        lights: [
            { type: 'key', name: 'Under Light', x: 0.5, y: 0.85, intensity: 100, colorTemp: 4000, softness: 20, enabled: true },
            { type: 'rim', name: 'Top Rim', x: 0.5, y: 0.05, intensity: 40, colorTemp: 6500, softness: 30, enabled: true },
        ]
    },
];
        ...
        (set, get) => ({
            ...
            generatePromptModifier: () => {
                ...
                for (const light of sortedLights) {
                    ...
                    const colorDesc = light.useGel && light.gelColor
