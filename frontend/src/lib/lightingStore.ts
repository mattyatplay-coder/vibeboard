...
export const LIGHTING_PRESETS: LightingPreset[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    id: 'ring_light',
    name: 'Ring Light',
    description: 'Classic vlogger/influencer ring light setup',
    lights: [
      {
        type: 'key',
        name: 'Ring Light',
        x: 0.5,
        y: 0.7, // Front-center, slightly above camera
        intensity: 85,
        colorTemp: 5200,
        softness: 75,
        enabled: true,
  ...
  },
  {
    ...
    description: 'Ring light with warm tones for intimate content',
    lights: [
      {
        type: 'key',
        name: 'Ring Light',
  ...
  },
  {
    id: 'tech_studio',
    name: 'Tech Studio',
    description: 'Clean, professional lighting for product reviews',
    lights: [
      {
        type: 'key',
        name: 'Softbox Key',
  ...
  },
  {
    id: 'rgb_streamer',
    name: 'RGB Streamer',
    description: 'Gaming/streaming setup with colorful accents',
    lights: [
      {
        type: 'key',
        name: 'Key Light',
  ...
  },
  {
    id: 'rgb_rim',
    name: 'RGB Rim Light',
    description: 'Dramatic colored rim lighting for cosplay/performance',
    lights: [
      {
        type: 'rim',
        name: 'Rim Left',
  ...
  },
  {
    id: 'beauty_soft',
    name: 'Beauty Soft',
    description: 'Soft, flattering light for boudoir/beauty content',
    lights: [
      {
        type: 'key',
        name: 'Large Softbox',
  ...
  },
  {
    id: 'natural_soft',
    name: 'Natural Soft',
    description: 'Soft window-style natural lighting',
    lights: [
      {
        type: 'key',
        name: 'Window Light',
  ...
  {
    id: 'three_point',
    name: 'Three-Point Interview',
    description: 'Professional interview/podcast lighting',
    lights: [
      {
        type: 'key',
        name: 'Key Light',
  ...
  },
  {
    id: 'soft_key',
    name: 'Soft Key Only',
    description: 'Single soft key light for tutorials',
    lights: [
      {
        type: 'key',
        name: 'Soft Key',
  ...
  },
  {
    id: 'practical',
    name: 'Practical Only',
    description: 'Available light / practical lamps only',
    lights: [
      {
        type: 'practical',
        name: 'Practical Lamp',
