...
export const ALL_MODELS: ModelInfo[] = [
    ...
    { id: 'fal-ai/wan-25-preview/text-to-video', name: 'Wan 2.5', provider: 'fal', capability: 'text-to-video', type: 'video', desc: 'Latest Wan with improved quality, motion coherence, and text alignment (no LoRA support)', supportedDurations: ['5s', '10s'] },
    { id: 'fal-ai/wan/v2.6/text-to-video', name: 'Wan 2.6', provider: 'fal', capability: 'text-to-video', type: 'video', desc: 'Multi-shot video with native audio sync, 1080p support, and extended 15s duration', supportedDurations: ['5s', '10s', '15s'] },
    ...
    { id: 'fal-ai/wan-25-preview/image-to-video', name: 'Wan 2.5 I2V', provider: 'fal', capability: 'image-to-video', type: 'video', desc: 'Latest Wan image animation with improved quality and motion (no LoRA support)', supportedDurations: ['5s', '10s'] },
    { id: 'fal-ai/wan/v2.6/image-to-video', name: 'Wan 2.6 I2V', provider: 'fal', capability: 'image-to-video', type: 'video', desc: 'Multi-shot image animation with native audio sync and 1080p support', supportedDurations: ['5s', '10s', '15s'] },
    { id: 'fal-ai/wan/v2.6/reference-to-video', name: 'Wan 2.6 R2V', provider: 'fal', capability: 'image-to-video', type: 'video', desc: 'Reference-to-video with 1-3 reference videos for character consistency (@Video1, @Video2, @Video3)', supportedDurations: ['5s', '10s', '15s'] },
