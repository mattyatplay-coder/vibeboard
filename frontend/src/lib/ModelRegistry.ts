...
export const ALL_MODELS: ModelInfo[] = [
  ...
  // === TOGETHER AI ===
  // Cheap, fast image generation with uncensored models
  {
    ...
    capability: 'text-to-image',
    type: 'image',
    desc: 'Fastest FLUX model via Together AI - $0.003/image, 4 steps only',
    cost: '$0.003',
    tier: 'fast',
    bestFor: 'Ultra-Fast & Cheap',
  },
  {
    ...
    capability: 'text-to-image',
    type: 'image',
    desc: 'High-quality FLUX via Together AI - $0.025/image',
    cost: '$0.025',
    bestFor: 'Quality + Value',
  },
  {
    id: 'together/dreamshaper',
    name: 'DreamShaper',
    provider: 'together',
    capability: 'text-to-image',
    type: 'image',
    desc: 'Artistic style model - $0.0006/image, no content filters',
    cost: '$0.0006',
    tier: 'fast',
    bestFor: 'Artistic & Uncensored',
  },
  {
    id: 'together/hidream-full',
    name: 'HiDream I1 Full',
    provider: 'together',
    capability: 'text-to-image',
    type: 'image',
    desc: 'High-resolution generation - $0.009/image',
    cost: '$0.009',
    tier: 'quality',
    bestFor: 'High Resolution',
  },
  {
    id: 'together/hidream-dev',
    name: 'HiDream I1 Dev',
    provider: 'together',
    capability: 'text-to-image',
    type: 'image',
    desc: 'Balanced quality/speed - $0.0045/image',
    cost: '$0.0045',
    bestFor: 'Balanced',
  },
  {
    id: 'together/hidream-fast',
    name: 'HiDream I1 Fast',
    provider: 'together',
    capability: 'text-to-image',
    type: 'image',
    desc: 'Fast HiDream variant - $0.0032/image',
    cost: '$0.0032',
    tier: 'fast',
    bestFor: 'Fast HiDream',
  },
  {
    id: 'together/juggernaut-pro',
    name: 'Juggernaut Pro Flux',
    provider: 'together',
    capability: 'text-to-image',
    type: 'image',
    desc: 'Premium RunDiffusion model - $0.0049/image, photorealistic',
    cost: '$0.0049',
    tier: 'quality',
    bestFor: 'Photorealism',
  },
  {
    id: 'together/juggernaut-lightning',
    name: 'Juggernaut Lightning',
    provider: 'together',
    capability: 'text-to-image',
    type: 'image',
    desc: 'Fast Juggernaut variant - $0.0017/image',
    cost: '$0.0017',
    tier: 'fast',
  ...
  // === CIVITAI ===
  // Community models with LoRA support
  {
    id: 'civitai/sdxl',
    name: 'SDXL 1.0',
    provider: 'civitai',
    capability: 'text-to-image',
    type: 'image',
    desc: 'Stable Diffusion XL via Civitai with community LoRA support',
  ...
  },
  {
    ...
    capability: 'text-to-image',
    type: 'image',
    desc: 'Stylized anime/cartoon generation with extensive LoRA library',
  ...
  },
  {
    ...
    capability: 'text-to-image',
    type: 'image',
    desc: 'Photorealistic SD 1.5 model - fast, uncensored',
    tier: 'fast',
    bestFor: 'Uncensored Realism',
  },
  {
    id: 'civitai/flux-d',
    name: 'FLUX.1 D',
    ...
    capability: 'text-to-image',
    type: 'image',
    desc: 'FLUX via Civitai with community LoRA support',
    bestFor: 'FLUX + LoRAs',
  },
  {
    id: 'civitai/wan-t2v',
    ...
    capability: 'text-to-video',
    type: 'video',
    desc: 'Alibaba Wan video generation via Civitai',
    supportedDurations: ['5s', '10s'],
    bestFor: 'Video + LoRAs',
  },
  {
    ...
    capability: 'image-to-video',
    type: 'video',
    desc: 'Alibaba Wan image-to-video via Civitai with LoRA support',
    supportedDurations: ['5s', '10s'],
    bestFor: 'Animation + LoRAs',
  },
  ...
  // Zero marginal cost models running on your own GPU
  {
    ...
    capability: 'text-to-video',
    type: 'video',
    desc: 'Self-hosted 14B cinematic model. Zero marginal cost.',
    cost: '$0',
    tier: 'pro',
    supportedDurations: ['5s'],
    bestFor: 'High Quality Video',
  },
  {
    id: 'runpod/wan-2.1-i2v-14b',
    name: 'Wan 2.1 (14B) I2V',
    provider: 'runpod',
    capability: 'image-to-video',
    type: 'video',
    desc: 'Animate images with 14B parameter precision.',
    cost: '$0',
    tier: 'pro',
    supportedDurations: ['5s'],
  ...
  {
    id: 'runpod/infcam',
    name: 'InfCam (Camera Control)',
    provider: 'runpod',
    capability: 'image-to-video',
    type: 'video',
    desc: 'Reshoot video with new camera movements.',
    cost: '$0',
    tier: 'pro',
    bestFor: 'Virtual Reshoots',
  },
  {
    id: 'runpod/spatia',
    name: 'Spatia (Spatial Memory)',
    provider: 'runpod',
    capability: 'text-to-video',
    type: 'video',
    desc: 'Generate video with consistent 3D geometry.',
    cost: '$0',
    tier: 'pro',
    bestFor: 'Virtual Sets',
  },
  {
    id: 'runpod/flash-portrait',
    name: 'FlashPortrait (Performance)',
    provider: 'runpod',
    capability: 'image-to-video',
    type: 'video',
    desc: 'Infinite-length talking head generation from audio.',
    cost: '$0',
    tier: 'pro',
    bestFor: 'Dialogue',
  },
  {
    ...
    capability: 'image-editing',
    type: 'image',
    desc: 'Instruction-based image editing (e.g. "make him smile").',
    cost: '$0',
    tier: 'pro',
