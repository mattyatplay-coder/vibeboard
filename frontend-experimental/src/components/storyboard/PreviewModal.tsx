...
export function PreviewModal({ isOpen, onClose, scenes }: PreviewModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-[100] bg-black flex flex-col">
            {/* Header */}
            <div className="h-16 flex items-center justify-between px-6 bg-gradient-to-b from-black/80 to-transparent absolute top-0 left-0 right-0 z-10 pointer-events-none">
                ...
                <button
                    onClick={onClose}
                    className="p-2 bg-black/40 hover:bg-white/20 rounded-full text-white transition-colors pointer-events-auto backdrop-blur-sm"
                >
                    <X className="w-6 h-6" />
                </button>
            </div>
            ...
            {/* Controls */}
            <div className="h-24 bg-gradient-to-t from-black/90 to-transparent absolute bottom-0 left-0 right-0 flex flex-col justify-end pb-6 px-8 z-10">
                {/* Progress Bar */}
                <div className="w-full h-1 bg-white/20 rounded-full mb-4 overflow-hidden cursor-pointer group">
                    <div
                ...
                <div className="flex items-center justify-between">
                    <div className="text-sm text-gray-400 font-mono w-20">
