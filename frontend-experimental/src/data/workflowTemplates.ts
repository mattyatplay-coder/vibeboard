...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
    {
        ...
        config: {
            ...
            prompt: "Cinematic product shot of [Product Name], professional lighting, 8k resolution, highly detailed texture, slow smooth motion."
        }
    },
    {
        ...
        config: {
            ...
            prompt: "Epic cinematic shot of [Subject], dramatic atmosphere, movie trailer style, volumetric fog, anamorphic lens flares, color graded."
        }
    },
    {
        ...
        config: {
            ...
            prompt: "Trendy social media clip of [Subject], vibrant colors, sharp focus, modern aesthetic, high energy."
        }
    },
    {
        ...
        config: {
            ...
            prompt: "Detailed portrait of [Character], expressive eyes, skin texture, subtle movement, emotional atmosphere, bokeh background."
        }
    }
];
