...
export function useGeneration({ projectId, selectedSessionId, loadGenerations, loadElements, loadScenes }: UseGenerationProps) {
    ...
    return {
        ...
        referenceCreativity, setReferenceCreativity,
        elementStrengths, setElementStrengths,
        ...
        // Modal State Exports
        isRetakeModalOpen, setIsRetakeModalOpen,
        retakeVideoUrl,
        isImageInpaintModalOpen, setIsImageInpaintModalOpen,
        inpaintImageUrl,
